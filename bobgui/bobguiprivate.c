...
_bobgui_get_lc_ctype (void)
{
   ...
   * kicks, do obey LC_ALL, LC_CTYPE and LANG in BOBGUI. (This also makes
   * it easier to test BOBGUI and Pango in various default languages, you
...
gboolean
_bobgui_boolean_handled_accumulator (GSignalInvocationHint *ihint,
                                  GValue                *return_accu,
...
gboolean
_bobgui_single_string_accumulator (GSignalInvocationHint *ihint,
				GValue                *return_accu,
				const GValue          *handler_return,
				gpointer               dummy)
{
...
{
  _bobgui_register_resource ();
  return NULL;
}

void
_bobgui_ensure_resources (void)
{
...
/*
 * bobgui_get_portal_interface_version:
 ...
 */
guint
bobgui_get_portal_interface_version (GDBusConnection *connection,
...
char *
bobgui_get_portal_request_path (GDBusConnection  *connection,
                             char            **token)
{
...
char *
bobgui_get_portal_session_path (GDBusConnection  *connection,
                             char            **token)
{
...
char *
_bobgui_elide_underscores (const char *original)
{
  char *q, *result;
  const char *p, *end;
  gsize len;
