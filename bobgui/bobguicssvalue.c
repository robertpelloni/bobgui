...
G_DEFINE_BOXED_TYPE (BobguiCssValue, bobgui_css_value, bobgui_css_value_ref, bobgui_css_value_unref)
...
BobguiCssValue *
bobgui_css_value_alloc (const BobguiCssValueClass *klass,
                     gsize                   size)
{
...
BobguiCssValue *
(bobgui_css_value_ref) (BobguiCssValue *value)
{
  bobgui_internal_return_val_if_fail (value != NULL, NULL);
...
void
(bobgui_css_value_unref) (BobguiCssValue *value)
{
  if (value == NULL)
    return;
 ...
 **/
BobguiCssValue *
bobgui_css_value_compute (BobguiCssValue          *value,
                       guint                 property_id,
                       BobguiCssComputeContext *context)
{
  if (bobgui_css_value_is_computed (value))
 ...
 */
BobguiCssValue *
bobgui_css_value_resolve (BobguiCssValue          *value,
                       BobguiCssComputeContext *context,
...
gboolean
bobgui_css_value_equal (const BobguiCssValue *value1,
                     const BobguiCssValue *value2)
{
  bobgui_internal_return_val_if_fail (value1 != NULL, FALSE);
  bobgui_internal_return_val_if_fail (value2 != NULL, FALSE);
...
gboolean
bobgui_css_value_equal0 (const BobguiCssValue *value1,
                      const BobguiCssValue *value2)
{
  ...
  return bobgui_css_value_equal (value1, value2);
}

BobguiCssValue *
bobgui_css_value_transition (BobguiCssValue *start,
                          BobguiCssValue *end,
                          guint        property_id,
                          double       progress)
{
  bobgui_internal_return_val_if_fail (start != NULL, NULL);
  bobgui_internal_return_val_if_fail (end != NULL, NULL);
  ...
  if (progress == 1)
    return bobgui_css_value_ref (end);
...
char *
bobgui_css_value_to_string (const BobguiCssValue *value)
{
  GString *string;
 ...
 * via _bobgui_style_property_assign().
 **/
void
bobgui_css_value_print (const BobguiCssValue *value,
                     GString           *string)
{
...
/**
 * bobgui_css_value_is_dynamic:
 * @value: a `BobguiCssValue`
 *
 ...
 *
 * Use bobgui_css_value_get_dynamic_value() to get the value for a given timestamp.
 *
 * Returns %TRUE if the value is dynamic
 */
gboolean
bobgui_css_value_is_dynamic (const BobguiCssValue *value)
{
...
/**
 * bobgui_css_value_get_dynamic_value:
 * @value: a `BobguiCssValue`
 ...
 *
 * See bobgui_css_value_is_dynamic() for details about dynamic values.
 *
 * Returns: (transfer full): The dynamic value for @value at the given
 *   timestamp
 */
BobguiCssValue *
bobgui_css_value_get_dynamic_value (BobguiCssValue *value,
