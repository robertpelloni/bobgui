                          ...
                          GCancellable *cancellable)
{
  ...
  if (source_object)
    {
      parent_surface = bobgui_native_get_surface (BOBGUI_NATIVE (source_object));
...
void
bobgui_show_uri_win32 (BobguiWindow          *parent,
                    ...
                    gpointer            user_data)
{
  ...
  g_task_set_source_tag (task, bobgui_show_uri_win32);
...
gboolean
bobgui_show_uri_win32_finish (BobguiWindow    *parent,
                           GAsyncResult *result,
                           GError      **error)
{
...
void
bobgui_open_containing_folder_win32 (const char         *path,
                                  GCancellable       *cancellable,
                                  GAsyncReadyCallback callback,
                                  gpointer            user_data)
{
  ...
  g_task_set_source_tag (task, bobgui_open_containing_folder_win32);
...
gboolean
bobgui_open_containing_folder_win32_finish (GAsyncResult *result,
                                         GError      **error)
{
