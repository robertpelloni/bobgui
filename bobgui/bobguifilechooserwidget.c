 ...
 * bobguifilechooserwidget.c: Embeddable file selector widget
...
#include "bobguicolumnviewsorter.h"
...
/**
 * BobguiFileChooserWidget:
 *
 * `BobguiFileChooserWidget` is a widget for choosing files.
 *
 * It exposes the [iface@Bobgui.FileChooser] interface, and you should
 * use the methods of this interface to interact with the
 * widget.
 *
 * # Shortcuts and Gestures
 *
 * `BobguiFileChooserWidget` supports the following keyboard shortcuts:
 *
 * - <kbd>Shift</kbd>+<kbd>F10</kbd> or <kbd>Menu</kbd> opens the context menu.
 *
 * The following signals have default keybindings:
 *
 * - [signal@Bobgui.FileChooserWidget::desktop-folder]
 * - [signal@Bobgui.FileChooserWidget::down-folder]
 * - [signal@Bobgui.FileChooserWidget::home-folder]
 * - [signal@Bobgui.FileChooserWidget::location-popup]
 * - [signal@Bobgui.FileChooserWidget::location-popup-on-paste]
 * - [signal@Bobgui.FileChooserWidget::location-toggle-popup]
 * - [signal@Bobgui.FileChooserWidget::places-shortcut]
 * - [signal@Bobgui.FileChooserWidget::quick-bookmark]
 * - [signal@Bobgui.FileChooserWidget::recent-shortcut]
 * - [signal@Bobgui.FileChooserWidget::search-shortcut]
 * - [signal@Bobgui.FileChooserWidget::show-hidden]
 * - [signal@Bobgui.FileChooserWidget::up-folder]
 *
 * # CSS nodes
 *
 * `BobguiFileChooserWidget` has a single CSS node with name filechooser.
 *
 * Deprecated: 4.10: Direct use of `BobguiFileChooserWidget` is deprecated
 */
...
typedef struct _BobguiFileChooserWidgetClass   BobguiFileChooserWidgetClass;

struct _BobguiFileChooserWidget
{
  ...
  /* Save mode widgets */
  BobguiWidget *save_widgets;
  BobguiWidget *save_widgets_table;
  ...
  BobguiWidget *browse_widgets_hpaned;
  BobguiWidget *browse_header_revealer;
  BobguiWidget *browse_header_stack;
  BobguiWidget *browse_files_stack;
  BobguiWidget *browse_files_swin;
  BobguiWidget *browse_files_column_view;
  BobguiWidget *browse_files_grid_view;
  BobguiWidget *browse_toggle_view_button;
  BobguiWidget *remote_warning_bar;

  BobguiWidget *browse_files_popover;
  guint browse_files_popover_item;
  double browse_files_popover_x;
  double browse_files_popover_y;

  BobguiWidget *browse_new_folder_button;
  BobguiSizeGroup *browse_path_bar_size_group;
  BobguiWidget *browse_path_bar;
  BobguiWidget *new_folder_name_entry;
  BobguiWidget *new_folder_create_button;
  BobguiWidget *new_folder_error_stack;
  BobguiWidget *new_folder_popover;
  BobguiWidget *rename_file_name_entry;
  BobguiWidget *rename_file_rename_button;
  BobguiWidget *rename_file_error_stack;
  BobguiWidget *rename_file_popover;
  GFile *rename_file_source_file;

  BobguiFileSystemModel *browse_files_model;
  char *browse_files_last_selected_name;

  BobguiWidget *places_sidebar;
  BobguiWidget *places_view;
  StartupMode startup_mode;

  /* OPERATION_MODE_SEARCH */
  BobguiWidget *search_entry;
  BobguiWidget *search_spinner;
  guint show_progress_timeout;
  BobguiSearchEngine *search_engine;
  BobguiQuery *search_query;
  BobguiFileSystemModel *search_model;
  BobguiFileSystemModel *model_for_search;

  /* OPERATION_MODE_RECENT */
  BobguiRecentManager *recent_manager;
  BobguiFileSystemModel *recent_model;

  BobguiWidget *extra_and_filters;
  BobguiWidget *filter_combo_hbox;
  BobguiWidget *filter_combo;
  BobguiWidget *extra_align;
  BobguiWidget *extra_widget;

  BobguiWidget *location_entry_box;
  BobguiWidget *location_entry;
  LocationMode location_mode;

  BobguiWidget *external_entry;
  BobguiEventController *external_entry_controller;

  BobguiWidget *choice_box;
  GHashTable *choices;
  ...
  BobguiColumnViewColumn *column_view_name_column;
  BobguiColumnViewColumn *column_view_location_column;
  BobguiColumnViewColumn *column_view_size_column;
  BobguiColumnViewColumn *column_view_time_column;
  BobguiColumnViewColumn *column_view_type_column;
  ...
  BobguiWidget *toplevel_current_focus_widget;
  BobguiWidget *toplevel_last_focus_widget;
...
struct _BobguiFileChooserWidgetClass
{
...
static void bobgui_file_chooser_widget_iface_init       (BobguiFileChooserIface        *iface);

static void     bobgui_file_chooser_widget_constructed  (GObject               *object);
static void     bobgui_file_chooser_widget_finalize     (GObject               *object);
static void     bobgui_file_chooser_widget_set_property (GObject               *object,
                                                       guint                  prop_id,
                                                       const GValue          *value,
                                                       GParamSpec            *pspec);
static void     bobgui_file_chooser_widget_get_property (GObject               *object,
                                                       guint                  prop_id,
                                                       GValue                *value,
                                                       GParamSpec            *pspec);
static void     bobgui_file_chooser_widget_dispose      (GObject               *object);
static void     bobgui_file_chooser_widget_map            (BobguiWidget             *widget);
static void     bobgui_file_chooser_widget_unmap          (BobguiWidget             *widget);
static void     bobgui_file_chooser_widget_root           (BobguiWidget             *widget);
static void     bobgui_file_chooser_widget_unroot         (BobguiWidget             *widget);

static gboolean       bobgui_file_chooser_widget_set_current_folder           (BobguiFileChooser    *chooser,
                                                                            GFile             *folder,
                                                                            GError           **error);
static gboolean       bobgui_file_chooser_widget_update_current_folder        (BobguiFileChooser    *chooser,
                                                                            GFile             *folder,
                                                                            gboolean           keep_trail,
                                                                            gboolean           clear_entry,
                                                                            GError           **error);
static GFile *        bobgui_file_chooser_widget_get_current_folder           (BobguiFileChooser    *chooser);
static void           bobgui_file_chooser_widget_set_current_name             (BobguiFileChooser    *chooser,
                                                                            const char        *name);
static char *        bobgui_file_chooser_widget_get_current_name             (BobguiFileChooser    *chooser);
static gboolean       bobgui_file_chooser_widget_select_file                  (BobguiFileChooser    *chooser,
                                                                            GFile             *file,
                                                                            GError           **error);
static void           bobgui_file_chooser_widget_unselect_file                (BobguiFileChooser    *chooser,
                                                                            GFile             *file);
static void           bobgui_file_chooser_widget_select_all                   (BobguiFileChooser    *chooser);
static void           bobgui_file_chooser_widget_unselect_all                 (BobguiFileChooser    *chooser);
static GListModel *   bobgui_file_chooser_widget_get_files                    (BobguiFileChooser    *chooser);
static void           bobgui_file_chooser_widget_add_filter                   (BobguiFileChooser    *chooser,
                                                                            BobguiFileFilter     *filter);
static void           bobgui_file_chooser_widget_remove_filter                (BobguiFileChooser    *chooser,
                                                                            BobguiFileFilter     *filter);
static GListModel *   bobgui_file_chooser_widget_get_filters                  (BobguiFileChooser    *chooser);
static gboolean       bobgui_file_chooser_widget_add_shortcut_folder    (BobguiFileChooser    *chooser,
                                                                       GFile             *file,
                                                                       GError           **error);
static gboolean       bobgui_file_chooser_widget_remove_shortcut_folder (BobguiFileChooser    *chooser,
                                                                       GFile             *file,
                                                                       GError           **error);
static GListModel *   bobgui_file_chooser_widget_get_shortcut_folders   (BobguiFileChooser    *chooser);

static void        bobgui_file_chooser_widget_add_choice    (BobguiFileChooser  *chooser,
                                                          const char      *id,
                                                          const char      *label,
                                                          const char     **options,
                                                          const char     **option_labels);
static void        bobgui_file_chooser_widget_remove_choice (BobguiFileChooser  *chooser,
                                                          const char      *id);
static void        bobgui_file_chooser_widget_set_choice    (BobguiFileChooser  *chooser,
                                                          const char      *id,
                                                          const char      *option);
static const char *bobgui_file_chooser_widget_get_choice    (BobguiFileChooser  *chooser,
                                                          const char      *id);


static void add_selection_to_recent_list (BobguiFileChooserWidget *impl);

static void location_popup_handler  (BobguiFileChooserWidget *impl,
                                     const char            *path);
static void location_popup_on_paste_handler (BobguiFileChooserWidget *impl);
static void location_toggle_popup_handler   (BobguiFileChooserWidget *impl);
static void up_folder_handler       (BobguiFileChooserWidget *impl);
static void down_folder_handler     (BobguiFileChooserWidget *impl);
static void home_folder_handler     (BobguiFileChooserWidget *impl);
static void desktop_folder_handler  (BobguiFileChooserWidget *impl);
static void quick_bookmark_handler  (BobguiFileChooserWidget *impl,
                                     int                    bookmark_index);
static void show_hidden_handler     (BobguiFileChooserWidget *impl);
static void search_shortcut_handler (BobguiFileChooserWidget *impl);
static void recent_shortcut_handler (BobguiFileChooserWidget *impl);
static void places_shortcut_handler (BobguiFileChooserWidget *impl);
static void update_appearance       (BobguiFileChooserWidget *impl);

static void operation_mode_set (BobguiFileChooserWidget *impl, OperationMode mode);
static void location_mode_set  (BobguiFileChooserWidget *impl, LocationMode new_mode);

static void set_current_filter   (BobguiFileChooserWidget *impl,
                                  BobguiFileFilter         *filter);

static void filter_combo_changed       (BobguiDropDown          *dropdown,
                                        GParamSpec           *pspec,
                                        BobguiFileChooserWidget *impl);
static void list_selection_changed     (BobguiSelectionModel    *selection_model,
                                        guint                 position,
                                        guint                 n_items,
                                        BobguiFileChooserWidget *impl);
static void list_items_changed         (GListModel           *model,
                                        ...
                                        guint                 added,
                                        BobguiFileChooserWidget *impl);
static void path_bar_clicked (BobguiPathBar            *path_bar,
                              GFile                 *file,
                              GFile                 *child,
                              gboolean               child_is_hidden,
                              BobguiFileChooserWidget *impl);

static void load_remove_timer (BobguiFileChooserWidget *impl, LoadState new_load_state);

static void location_switch_to_path_bar (BobguiFileChooserWidget *impl);

static void stop_loading_and_clear_list_model (BobguiFileChooserWidget *impl,
                                               gboolean remove_from_treeview);

static void     search_setup_widgets         (BobguiFileChooserWidget *impl);
static void     search_stop_searching        (BobguiFileChooserWidget *impl,
                                              gboolean               remove_query);
static void     search_clear_model           (BobguiFileChooserWidget *impl,
                                              gboolean               remove_from_treeview);
static void     search_entry_activate_cb     (BobguiFileChooserWidget *impl);
static void     search_entry_stop_cb         (BobguiFileChooserWidget *impl);
static void     settings_load                (BobguiFileChooserWidget *impl);

static void     update_show_filters          (BobguiFileChooserWidget *impl);

static gboolean recent_files_setting_is_enabled (BobguiFileChooserWidget *impl);
static void     recent_start_loading         (BobguiFileChooserWidget *impl);
static void     recent_clear_model           (BobguiFileChooserWidget *impl,
                                              gboolean               remove_from_treeview);
static void     set_model_filter             (BobguiFileChooserWidget *impl,
                                              BobguiFileFilter        *filter);
static void     switch_to_home_dir           (BobguiFileChooserWidget *impl);
static void     set_show_hidden              (BobguiFileChooserWidget *impl,
                                              gboolean              show_hidden);
static char *   get_type_information         (BobguiFileChooserWidget *impl,
                                              GFileInfo            *info);
static char *   my_g_format_date_for_display (BobguiFileChooserWidget *impl,
                                              glong                 secs);
static char *   my_g_format_time_for_display (BobguiFileChooserWidget *impl,
                                              glong                 secs);

G_DEFINE_TYPE_WITH_CODE (BobguiFileChooserWidget, bobgui_file_chooser_widget, BOBGUI_TYPE_WIDGET,
                         G_IMPLEMENT_INTERFACE (BOBGUI_TYPE_FILE_CHOOSER,
                                                bobgui_file_chooser_widget_iface_init))

static void
bobgui_file_chooser_widget_iface_init (BobguiFileChooserIface *iface)
{
  iface->select_file = bobgui_file_chooser_widget_select_file;
  iface->unselect_file = bobgui_file_chooser_widget_unselect_file;
  iface->select_all = bobgui_file_chooser_widget_select_all;
  iface->unselect_all = bobgui_file_chooser_widget_unselect_all;
  iface->get_files = bobgui_file_chooser_widget_get_files;
  iface->set_current_folder = bobgui_file_chooser_widget_set_current_folder;
  iface->get_current_folder = bobgui_file_chooser_widget_get_current_folder;
  iface->set_current_name = bobgui_file_chooser_widget_set_current_name;
  iface->get_current_name = bobgui_file_chooser_widget_get_current_name;
  iface->add_filter = bobgui_file_chooser_widget_add_filter;
  iface->remove_filter = bobgui_file_chooser_widget_remove_filter;
  iface->get_filters = bobgui_file_chooser_widget_get_filters;
  iface->add_shortcut_folder = bobgui_file_chooser_widget_add_shortcut_folder;
  iface->remove_shortcut_folder = bobgui_file_chooser_widget_remove_shortcut_folder;
  iface->get_shortcut_folders = bobgui_file_chooser_widget_get_shortcut_folders;
  iface->add_choice = bobgui_file_chooser_widget_add_choice;
  iface->remove_choice = bobgui_file_chooser_widget_remove_choice;
  iface->set_choice = bobgui_file_chooser_widget_set_choice;
  iface->get_choice = bobgui_file_chooser_widget_get_choice;
}

static void
pending_select_files_free (BobguiFileChooserWidget *impl)
{
...
static void
pending_select_files_add (BobguiFileChooserWidget *impl,
                          GFile                *file)
{
...
static void
bobgui_file_chooser_widget_finalize (GObject *object)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (object);
  ...
  G_OBJECT_CLASS (bobgui_file_chooser_widget_parent_class)->finalize (object);
}
...
static void setup_sorting (BobguiFileChooserWidget *impl);

static GListModel *
get_current_model (BobguiFileChooserWidget *self)
{
  return bobgui_filter_list_model_get_model (self->filter_model);
}

static void
set_current_model (BobguiFileChooserWidget *self,
                   GListModel           *model)
{
  bobgui_filter_list_model_set_model (self->filter_model, model);
  bobgui_filter_changed (bobgui_filter_list_model_get_filter (self->filter_model),
                      BOBGUI_FILTER_CHANGE_DIFFERENT);
  setup_sorting (self);
}

/* Extracts the parent folders out of the supplied list of BobguiRecentInfo* items, and returns
 * a list of GFile* for those unique parents.
 */
static GList *
_bobgui_file_chooser_extract_recent_folders (GList *infos)
{
  GList *l;
  GList *result;
  GHashTable *folders;
  ...
  for (l = infos; l; l = l->next)
    {
      ...
      uri = bobgui_recent_info_get_uri (info);
      file = g_file_new_for_uri (uri);

      mime_type = bobgui_recent_info_get_mime_type (info);
...
static void
error_message (BobguiFileChooserWidget *impl,
               const char            *msg,
               const char            *detail)
{
  BobguiWindow *parent = get_toplevel (BOBGUI_WIDGET (impl));
  BobguiAlertDialog *dialog;

  dialog = bobgui_alert_dialog_new ("%s", msg);
  bobgui_alert_dialog_set_detail (dialog, detail);
  bobgui_alert_dialog_show (dialog, parent);
  g_object_unref (dialog);
}

/* Shows a simple error dialog relative to a path.  Frees the GError as well. */
static void
error_dialog (BobguiFileChooserWidget *impl,
              const char            *msg,
              GError                *error)
{
  if (error)
...
static void
error_creating_folder_dialog (BobguiFileChooserWidget *impl,
                              GFile                 *file,
                              GError                *error)
{
  error_dialog (impl,
...
static void
error_with_file_under_nonfolder (BobguiFileChooserWidget *impl,
                                 GFile *parent_file)
{
  GError *error;
  char *uri, *msg;
...
static void
error_filename_to_long_dialog (BobguiFileChooserWidget *impl)
{
  error_message (impl,
 ...
 */
static void
error_selecting_folder_over_existing_file_dialog (BobguiFileChooserWidget *impl)
{
  error_message (impl,
...
static void
error_building_filename_dialog (BobguiFileChooserWidget *impl,
                                GError                *error)
{
...
static void
error_changing_folder_dialog (BobguiFileChooserWidget *impl,
                              GFile                 *file,
                              GError                *error)
{
...
static void
error_deleting_file (BobguiFileChooserWidget *impl,
                     GFile                *file,
                     GError               *error)
{
...
static void
error_trashing_file (BobguiFileChooserWidget *impl,
                     GFile                *file,
                     GError               *error)
{
...
static gboolean
change_folder_and_display_error (BobguiFileChooserWidget *impl,
                                 GFile                 *file,
                                 gboolean               clear_entry)
{
  GError *error;
   ...
   *     calls bobgui_file_chooser_set_current_folder()
   *       changing folders fails, sets model to NULL, thus freeing the path in (*)
   */

  error = NULL;
  result = bobgui_file_chooser_widget_update_current_folder (BOBGUI_FILE_CHOOSER (impl), file, TRUE, clear_entry, &error);
...
static void
new_folder_popover_active (BobguiWidget            *button,
                           GParamSpec           *pspec,
                           BobguiFileChooserWidget *impl)
{
  bobgui_editable_set_text (BOBGUI_EDITABLE (impl->new_folder_name_entry), "");
  bobgui_widget_set_sensitive (impl->new_folder_create_button, FALSE);
  bobgui_file_chooser_error_stack_set_error (BOBGUI_FILE_CHOOSER_ERROR_STACK (impl->new_folder_error_stack),
                                          FALSE,
                                          "no-error");
}
...
struct FileExistsData
{
  ...
  GFile *parent_file;
  GFile *file;
  BobguiWidget *error_stack;
  BobguiWidget *button;
  BobguiWidget *entry;
};

static void
update_error_state (BobguiWidget *entry,
                    BobguiWidget *error_stack)
{
  BobguiWidget *error;

  error = bobgui_file_chooser_error_stack_get_error (BOBGUI_FILE_CHOOSER_ERROR_STACK (error_stack));

  if (!error)
    {
      bobgui_widget_remove_css_class (entry, "error");
      bobgui_accessible_reset_state (BOBGUI_ACCESSIBLE (entry), BOBGUI_ACCESSIBLE_STATE_INVALID);
      bobgui_accessible_reset_relation (BOBGUI_ACCESSIBLE (entry), BOBGUI_ACCESSIBLE_RELATION_ERROR_MESSAGE);
    }
  else
    {
      bobgui_widget_add_css_class (entry, "error");
      ...
      bobgui_accessible_update_relation (BOBGUI_ACCESSIBLE (entry),
                                      BOBGUI_ACCESSIBLE_RELATION_ERROR_MESSAGE, error, NULL,
                                      -1);
    }
}
                         ...
                         gpointer      user_data)
{
  ...
  GFileInfo *info;
  BobguiFileChooserWidget *impl = data->impl;
  ...
  if (info != NULL)
    {
      bobgui_widget_set_sensitive (data->button, FALSE);
      bobgui_file_chooser_error_stack_set_error (BOBGUI_FILE_CHOOSER_ERROR_STACK (data->error_stack),
                                              _bobgui_file_info_consider_as_directory (info),
                                              "name-already-exists");
    }
  else
    {
      bobgui_widget_set_sensitive (data->button, TRUE);
...
static void
check_valid_child_name (BobguiFileChooserWidget *impl,
                        GFile                *parent,
                        const char           *name,
                        gboolean              is_folder,
                        GFile                *original,
                        ...
                        BobguiWidget            *entry)
{
  BobguiFileChooserErrorStack *stack = BOBGUI_FILE_CHOOSER_ERROR_STACK (error_stack);

  bobgui_widget_set_sensitive (button, FALSE);

  if (name[0] == '\0')
    bobgui_file_chooser_error_stack_set_error (stack, FALSE, "no-error");
  else if (strcmp (name, ".") == 0)
    bobgui_file_chooser_error_stack_set_error (stack, is_folder, "cannot-be-called-dot");
  else if (strcmp (name, "..") == 0)
    bobgui_file_chooser_error_stack_set_error (stack, is_folder, "cannot-be-called-dot-dot");
  else if (strchr (name, '/') != NULL)
    bobgui_file_chooser_error_stack_set_error (stack, is_folder, "name-cannot-contain-slash");
  else
    {
      GFile *file;
      GError *error = NULL;
      ...
      if (file == NULL)
        {
          bobgui_file_chooser_error_stack_set_custom_error (stack, error->message);
          g_error_free (error);
        }
      ...
      else
        {
          ...
          if (g_ascii_isspace (name[0]))
            bobgui_file_chooser_error_stack_set_error (stack, is_folder, "name-should-not-begin-with-space");
          else if (g_ascii_isspace (name[strlen (name) - 1]))
            bobgui_file_chooser_error_stack_set_error (stack, is_folder, "name-should-not-end-with-space");
          else if (name[0] == '.')
            bobgui_file_chooser_error_stack_set_error (stack, is_folder, "name-with-dot-is-hidden");
          else
            bobgui_file_chooser_error_stack_set_error (stack, FALSE, "no-error");
...
static void
new_folder_name_changed (BobguiEditable          *editable,
                         BobguiFileChooserWidget *impl)
{
  check_valid_child_name (impl,
                          impl->current_folder,
                          bobgui_editable_get_text (editable),
                          TRUE,
                          NULL,
                          impl->new_folder_error_stack,
                          impl->new_folder_create_button,
                          BOBGUI_WIDGET (editable));
}

static void
new_folder_create_clicked (BobguiButton            *button,
                           BobguiFileChooserWidget *impl)
{
  GError *error = NULL;
  GFile *file;
  ...
  name = bobgui_editable_get_text (BOBGUI_EDITABLE (impl->new_folder_name_entry));
  file = g_file_get_child_for_display_name (impl->current_folder, name, &error);

  bobgui_popover_popdown (BOBGUI_POPOVER (impl->new_folder_popover));
...
static void
selection_check (BobguiFileChooserWidget *impl,
                 ...
                 gboolean              *out_all_folders)
{
  ...
  all_files = TRUE;
  n_selected = 0;
  bitset = bobgui_selection_model_get_selection (impl->selection_model);

  for (bobgui_bitset_iter_init_first (&iter, bitset, &i);
       bobgui_bitset_iter_is_valid (&iter);
       bobgui_bitset_iter_next (&iter, &i))
    {
      GFileInfo *info;
      gboolean is_folder;

      info = g_list_model_get_item (G_LIST_MODEL (impl->selection_model), i);
      is_folder = _bobgui_file_info_consider_as_directory (info);
  ...
  g_clear_pointer (&bitset, bobgui_bitset_unref);
...
static void
places_sidebar_open_location_cb (BobguiPlacesSidebar     *sidebar,
                                 GFile                *location,
                                 ...
                                 BobguiFileChooserWidget *impl)
{
   ...
   */
  if (impl->location_entry && impl->action != BOBGUI_FILE_CHOOSER_ACTION_SAVE)
    clear_entry = TRUE;
  else
    clear_entry = FALSE;
...
static void
places_sidebar_show_error_message_cb (BobguiPlacesSidebar *sidebar,
                                      const char       *primary,
...
static gboolean
trigger_location_entry (BobguiWidget *widget,
                        GVariant  *arguments,
                        gpointer   unused)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (widget);

  if (impl->operation_mode == OPERATION_MODE_SEARCH)
    return FALSE;

  if (impl->action != BOBGUI_FILE_CHOOSER_ACTION_OPEN &&
      impl->action != BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    return FALSE;
...
add_to_shortcuts_cb (GSimpleAction *action,
                     ...
                     gpointer       data)
{
  BobguiFileChooserWidget *impl = data;
  BobguiBitsetIter iter;
  BobguiBitset *bitset;
  guint i;
  ...
  for (bobgui_bitset_iter_init_first (&iter, bitset, &i);
       ...
       bobgui_bitset_iter_next (&iter, &i))
    {
      ...
      _bobgui_bookmarks_manager_insert_bookmark (impl->bookmarks_manager, file, 0, NULL);
                            ...
                            void         *user_data)
{
  ...
  button = bobgui_alert_dialog_choose_finish (BOBGUI_ALERT_DIALOG (source), result, NULL);
...
static void
confirm_delete (BobguiFileChooserWidget *impl,
                GFile                *file,
                GFileInfo            *info)
{
  ...
  toplevel = get_toplevel (BOBGUI_WIDGET (impl));

  data = g_new (ConfirmDeleteData, 1);
  data->impl = impl;
  data->file = file;

  dialog = bobgui_alert_dialog_new (_("Are you sure you want to permanently delete “%s”?"), name);
  bobgui_alert_dialog_set_detail (dialog, _("If you delete an item, it will be permanently lost."));
  bobgui_alert_dialog_set_buttons (dialog, (const char *[]) { _("_Cancel"), _("_Delete"), NULL });
  bobgui_alert_dialog_set_cancel_button (dialog, 0);
  bobgui_alert_dialog_set_default_button (dialog, 1);
  bobgui_alert_dialog_choose (dialog, toplevel, NULL, on_confirm_delete_response, data);
}
...
static void
rename_file_name_changed (BobguiEntry             *entry,
                          BobguiFileChooserWidget *impl)
{
  GFileType file_type;
...
static void
rename_file_end (BobguiPopover           *popover,
                 BobguiFileChooserWidget *impl)
{
...
static void
rename_file_rename_clicked (BobguiButton            *button,
                            BobguiFileChooserWidget *impl)
{
  GFile *dest;
  const char * new_name;

  bobgui_popover_popdown (BOBGUI_POPOVER (impl->rename_file_popover));

  new_name = bobgui_editable_get_text (BOBGUI_EDITABLE (impl->rename_file_name_entry));
                ...
                gpointer       data)
{
  ...
  bobgui_widget_set_sensitive (impl->rename_file_rename_button, FALSE);
  ...
  bobgui_editable_set_text (BOBGUI_EDITABLE (impl->rename_file_name_entry), filename);
  g_free (filename);

  bobgui_popover_set_pointing_to (BOBGUI_POPOVER (impl->rename_file_popover), &rect);
  bobgui_popover_popup (BOBGUI_POPOVER (impl->rename_file_popover));
  bobgui_widget_grab_focus (impl->rename_file_popover);
}
                       ...
                       gpointer       data)
{
  ...
  clipboard = bobgui_widget_get_clipboard (BOBGUI_WIDGET (impl));
               ...
               gpointer       data)
{
  ...
  bobgui_file_chooser_widget_select_file (BOBGUI_FILE_CHOOSER (impl), file, NULL); /* NULL-GError */
...
{
  BobguiFileChooserWidget *impl = data;
  BobguiRoot *root = bobgui_widget_get_root (BOBGUI_WIDGET (impl));
  BobguiWindow *toplevel = BOBGUI_IS_WINDOW (root) ? BOBGUI_WINDOW (root) : NULL;
  GFileInfo *info;
  GFile *file;
  ...
  bobgui_file_launcher_open_containing_folder (launcher, toplevel, NULL, NULL, NULL);
                                     ...
                                     gpointer       data)
{
  ...
  bobgui_sorter_changed (bobgui_sort_list_model_get_sorter (impl->sort_model),
                      BOBGUI_SORTER_CHANGE_DIFFERENT);
}

static void
set_model_filter (BobguiFileChooserWidget *impl,
                  BobguiFileFilter        *filter)
{
  if (impl->browse_files_model)
    _bobgui_file_system_model_set_filter (impl->browse_files_model, filter);

  if (impl->search_model)
    _bobgui_file_system_model_set_filter (impl->search_model, filter);

  if (impl->recent_model)
    _bobgui_file_system_model_set_filter (impl->recent_model, filter);

  bobgui_filter_changed (bobgui_filter_list_model_get_filter (impl->filter_model),
                      BOBGUI_FILTER_CHANGE_DIFFERENT);
}
...
static void
error_selecting_dragged_file_dialog (BobguiFileChooserWidget *impl,
                                     GFile                 *file,
                                     GError                *error)
{
  error_dialog (impl,
...
static void
file_list_drag_data_select_files (BobguiFileChooserWidget  *impl,
                                  GSList                *files)
{
  BobguiFileChooser *chooser = BOBGUI_FILE_CHOOSER (impl);
  GSList *l;
  ...
  for (l = files; l; l = l->next)
    {
      ...
      bobgui_file_chooser_widget_select_file (chooser, file, &error);
      if (error)
                                          ...
                                          gpointer      user_data)
{
  ...
  if ((impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
       impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE) &&
      data->files->next == NULL && _bobgui_file_info_consider_as_directory (info))
    change_folder_and_display_error (data->impl, data->files->data, FALSE);
  else
    {
      GError *local_error = NULL;

      bobgui_file_chooser_widget_unselect_all (chooser);
      bobgui_file_chooser_widget_select_file (chooser, data->files->data, &local_error);
      if (local_error)
...
static gboolean
file_list_drag_drop_cb (BobguiDropTarget        *dest,
                        const GValue         *value,
                        double                x,
                        double                y,
                        BobguiFileChooserWidget *impl)
...
static void
check_file_list_popover_sensitivity (BobguiFileChooserWidget *impl)
{
  GAction *action;
  GFileInfo *info;
  gboolean is_folder;
  ...
  info = g_list_model_get_item (G_LIST_MODEL (impl->selection_model), impl->browse_files_popover_item);
  is_folder = info && _bobgui_file_info_consider_as_directory (info);
...
static void
file_list_show_popover (BobguiFileChooserWidget *impl,
                        double                x,
                        double                y);
...
popup_file_list_menu (GSimpleAction *action,
                      ...
                      gpointer       user_data)
{
  BobguiFileChooserWidget *impl = user_data;
  guint position;
  double x, y;
...
static BobguiWidget*
get_current_view_widget (BobguiFileChooserWidget *impl)
{
...
static void
set_view_type (BobguiFileChooserWidget *impl,
               ViewType              view_type)
{
  ...
  bobgui_widget_set_tooltip_text (impl->browse_toggle_view_button, tooltip_text);
  bobgui_button_set_icon_name (BOBGUI_BUTTON (impl->browse_toggle_view_button), icon_name);
  bobgui_scrolled_window_set_child (BOBGUI_SCROLLED_WINDOW (impl->browse_files_swin), child);
...
static void
file_list_build_popover (BobguiFileChooserWidget *impl)
{
  GMenu *menu, *section;
  GMenuItem *item;
  ...
  impl->browse_files_popover = bobgui_popover_menu_new_from_model (G_MENU_MODEL (menu));
  bobgui_widget_set_parent (impl->browse_files_popover, BOBGUI_WIDGET (impl));
  g_object_unref (menu);
}

/* Updates the popover for the file list, creating it if necessary */
static void
file_list_update_popover (BobguiFileChooserWidget *impl)
{
  GAction *action;
  gboolean state;
  gboolean visit;
   ...
   */
  state = impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE &&
          impl->operation_mode == OPERATION_MODE_BROWSE &&
          impl->browse_files_popover_item != BOBGUI_INVALID_LIST_POSITION;
                        ...
                        double                y)
{
  ...
  bobgui_popover_set_pointing_to (BOBGUI_POPOVER (impl->browse_files_popover), &rect);
  bobgui_popover_popup (BOBGUI_POPOVER (impl->browse_files_popover));
}

static gboolean
list_popup_menu_cb (BobguiWidget *widget,
                    GVariant  *args,
                    gpointer   user_data)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (user_data);
  graphene_rect_t bounds;
  BobguiWidget *view_widget;

  view_widget = get_current_view_widget (impl);

  if (!bobgui_widget_compute_bounds (view_widget, BOBGUI_WIDGET (impl), &bounds))
    return FALSE;
...
static gboolean
files_list_restrict_key_presses (BobguiEventControllerKey *controller,
                                 guint                  keyval,
                                 guint                  keycode,
                                 ...
                                 BobguiFileChooserWidget  *impl)
{
  if (impl->browse_files_interaction_frozen)
    {
      bobgui_event_controller_reset (BOBGUI_EVENT_CONTROLLER (controller));
...
static char *
get_file_date (BobguiFileChooserWidget *impl,
               GFileInfo            *info)
{
  glong time;
...
static char *
column_view_get_file_display_name (BobguiColumnViewCell *cell,
                                   GFileInfo        *info)
{
  if (info)
...
static char *
get_file_time (BobguiFileChooserWidget *impl,
                           GFileInfo        *info)
{
  glong time;
...
static void
column_view_row_bind (BobguiListItemFactory *factory,
                      BobguiColumnViewRow   *row,
                      gpointer            unused)
{
  GFileInfo *info;
  gboolean selectable;

  info = bobgui_column_view_row_get_item (row);
  selectable = g_file_info_get_attribute_boolean (info, "filechooser::selectable");

  bobgui_column_view_row_set_selectable (row, selectable);
}

static char *
file_chooser_get_location (BobguiFileChooserWidget *impl,
                           GFileInfo            *info)
{
  GFile *home_location;
  GFile *dir_location;
...
{
  if (info && !_bobgui_file_info_consider_as_directory (info))
...
static char *
column_view_get_tooltip_text (BobguiListItem *cell,
                              GFileInfo   *info)
{
  GFile *file;
...
static void
update_default (BobguiFileChooserWidget *impl)
{
  BobguiWidget *dialog;
  BobguiWidget *button;
  GListModel *files;
  ...
  dialog = bobgui_widget_get_ancestor (BOBGUI_WIDGET (impl), BOBGUI_TYPE_DIALOG);
  if (dialog == NULL)
    return;

  button = get_accept_action_widget (BOBGUI_DIALOG (dialog), FALSE);
  if (button == NULL)
    return;

  files = bobgui_file_chooser_get_files (BOBGUI_FILE_CHOOSER (impl));
  sensitive = (g_list_model_get_n_items (files) > 0 ||
               impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE ||
               impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER);
  bobgui_widget_set_sensitive (button, sensitive);
...
location_changed_timeout_cb (gpointer user_data)
{
  ...
  bobgui_file_chooser_unselect_all (BOBGUI_FILE_CHOOSER (impl));
...
static void
location_entry_changed_cb (BobguiEditable          *editable,
                           BobguiFileChooserWidget *impl)
{
  if (impl->operation_mode == OPERATION_MODE_SEARCH)
    {
  ...
  if (impl->action != BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      ...
      impl->location_changed_id = g_timeout_add (LOCATION_CHANGED_TIMEOUT,
                                                ...
                                                impl);
      gdk_source_set_static_name_by_id (impl->location_changed_id, "[bobgui] location_changed_timeout_cb");
    }
}

static void
location_entry_close_clicked (BobguiFileChooserWidget *impl)
{
  location_mode_set (impl, LOCATION_MODE_PATH_BAR);
  bobgui_widget_grab_focus (BOBGUI_WIDGET (impl));
}

static void
location_entry_setup (BobguiFileChooserWidget *impl)
{
  if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
      impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    bobgui_entry_set_placeholder_text (BOBGUI_ENTRY (impl->location_entry), _("Location"));
  ...
  _bobgui_file_chooser_entry_set_action (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), impl->action);
  _bobgui_file_chooser_entry_set_file_filter (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry),
                                           impl->current_filter);
  bobgui_editable_set_width_chars (BOBGUI_EDITABLE (impl->location_entry), 45);
  bobgui_entry_set_activates_default (BOBGUI_ENTRY (impl->location_entry), TRUE);
  bobgui_widget_set_hexpand (impl->location_entry, TRUE);
}

static void
location_entry_disconnect (BobguiFileChooserWidget *impl)
{
...
static void
location_entry_create (BobguiFileChooserWidget *impl)
{
  if (!impl->location_entry)
    {
      gboolean eat_escape;

      eat_escape = impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
                   impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER;

      impl->location_entry = _bobgui_file_chooser_entry_new (TRUE, eat_escape);
      location_entry_setup (impl);
    }
}

static gboolean
forward_key (BobguiEventControllerKey *key,
             guint                  keyval,
             guint                  keycode,
             ...
             BobguiFileChooserWidget  *impl)
{
   ...
   */
  return bobgui_event_controller_key_forward (key, BOBGUI_WIDGET (impl));
}

static void
external_entry_setup (BobguiFileChooserWidget *impl)
{
   ...
   * the hierarchy of BobguiFileChooserWidget) */

  impl->external_entry_controller = bobgui_event_controller_key_new ();
  bobgui_event_controller_set_propagation_phase (impl->external_entry_controller,
                                              BOBGUI_PHASE_BUBBLE);
  g_signal_connect (impl->external_entry_controller, "key-pressed",
                    G_CALLBACK (forward_key), impl);
  bobgui_widget_add_controller (impl->external_entry, impl->external_entry_controller);
}

static void
external_entry_disconnect (BobguiFileChooserWidget *impl)
{
  bobgui_widget_remove_controller (impl->external_entry, impl->external_entry_controller);
  impl->external_entry_controller = NULL;
}

/* Creates the widgets specific to Save mode */
static void
save_widgets_create (BobguiFileChooserWidget *impl)
{
  BobguiWidget *vbox;
  BobguiWidget *widget;
  ...
  bobgui_places_sidebar_set_location (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), impl->current_folder);
  ...
  bobgui_widget_add_css_class (vbox, "search-bar");

  impl->save_widgets_table = bobgui_grid_new ();
  bobgui_box_append (BOBGUI_BOX (vbox), impl->save_widgets_table);
  bobgui_grid_set_row_spacing (BOBGUI_GRID (impl->save_widgets_table), 12);
  bobgui_grid_set_column_spacing (BOBGUI_GRID (impl->save_widgets_table), 12);

  /* Label */

  widget = bobgui_label_new_with_mnemonic (_("_Name:"));
  bobgui_widget_set_halign (widget, BOBGUI_ALIGN_START);
  bobgui_widget_set_valign (widget, BOBGUI_ALIGN_CENTER);
  bobgui_grid_attach (BOBGUI_GRID (impl->save_widgets_table), widget, 0, 0, 1, 1);

  /* Location entry */

  location_entry_create (impl);
  bobgui_widget_set_hexpand (impl->location_entry, TRUE);
  bobgui_grid_attach (BOBGUI_GRID (impl->save_widgets_table), impl->location_entry, 1, 0, 1, 1);
  bobgui_widget_set_visible (impl->location_entry, TRUE);
  bobgui_label_set_mnemonic_widget (BOBGUI_LABEL (widget), impl->location_entry);

  impl->save_widgets = vbox;
  bobgui_box_insert_child_after (BOBGUI_BOX (impl->box), impl->save_widgets, NULL);
}

/* Destroys the widgets specific to Save mode */
static void
save_widgets_destroy (BobguiFileChooserWidget *impl)
{
  ...
  bobgui_box_remove (BOBGUI_BOX (impl->box), impl->save_widgets);
 ...
 */
static void
location_switch_to_path_bar (BobguiFileChooserWidget *impl)
{
  g_clear_pointer (&impl->location_entry, bobgui_widget_unparent);
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_header_stack), "pathbar");
}
 ...
 */
static void
location_switch_to_filename_entry (BobguiFileChooserWidget *impl)
{
  ...
  bobgui_revealer_set_reveal_child (BOBGUI_REVEALER (impl->browse_header_revealer), TRUE);

  if (!impl->location_entry)
    {
      location_entry_create (impl);
      bobgui_box_append (BOBGUI_BOX (impl->location_entry_box), impl->location_entry);
    }

  _bobgui_file_chooser_entry_set_base_folder (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), impl->current_folder);

  bobgui_widget_set_visible (impl->location_entry, TRUE);

  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_header_stack), "location");

  bobgui_widget_grab_focus (impl->location_entry);
}

/* Sets a new location mode.
 */
static void
location_mode_set (BobguiFileChooserWidget *impl,
      ...
      impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      ...
      switch (new_mode)
        ...
        case LOCATION_MODE_PATH_BAR:
          ...
          if (toplevel)
            {
              current_focus = bobgui_root_get_focus (BOBGUI_ROOT (toplevel));
          ...
          if (switch_to_file_list)
            bobgui_widget_grab_focus (get_current_view_widget (impl));
...
static void
places_sidebar_show_other_locations_with_flags_cb (BobguiPlacesSidebar     *sidebar,
                                                   BobguiPlacesOpenFlags    open_flags,
                                                   BobguiFileChooserWidget *impl)
{
...
static void
location_toggle_popup_handler (BobguiFileChooserWidget *impl)
{
  if ((impl->operation_mode == OPERATION_MODE_RECENT ||
       impl->operation_mode == OPERATION_MODE_SEARCH) &&
      (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
       impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER))
    operation_mode_set (impl, OPERATION_MODE_BROWSE);
   ...
   */
  if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
    {
      bobgui_widget_grab_focus (impl->location_entry);
    }
    ...
    {
      if (bobgui_widget_has_focus (impl->location_entry))
        {
          location_mode_set (impl, LOCATION_MODE_PATH_BAR);
        }
      else
...
static void
bobgui_file_chooser_widget_constructed (GObject *object)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (object);

  G_OBJECT_CLASS (bobgui_file_chooser_widget_parent_class)->constructed (object);

  update_appearance (impl);
}

static void
update_extra_and_filters (BobguiFileChooserWidget *impl)
{
  bobgui_widget_set_visible (impl->extra_and_filters,
                          bobgui_widget_get_visible (impl->extra_align) ||
                          bobgui_widget_get_visible (impl->filter_combo_hbox));
}

/* Sets the extra_widget by packing it in the appropriate place */
static void
set_extra_widget (BobguiFileChooserWidget *impl,
                  BobguiWidget             *extra_widget)
{
  if (extra_widget)
  ...
  if (impl->extra_widget)
    {
      bobgui_box_remove (BOBGUI_BOX (impl->extra_align), impl->extra_widget);
      g_object_unref (impl->extra_widget);
    }

  impl->extra_widget = extra_widget;
  bobgui_widget_set_visible (impl->extra_align, extra_widget != NULL);
  if (impl->extra_widget)
    bobgui_box_append (BOBGUI_BOX (impl->extra_align), impl->extra_widget);
...
static void
switch_to_home_dir (BobguiFileChooserWidget *impl)
{
  ...
  bobgui_file_chooser_set_current_folder (BOBGUI_FILE_CHOOSER (impl), home_file, NULL); /* NULL-GError */
...
static void
set_select_multiple (BobguiFileChooserWidget *impl,
                     gboolean              select_multiple)
{
  ...
  bobgui_column_view_set_enable_rubberband (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view),
                                         select_multiple);
  ...
  if (select_multiple)
    impl->selection_model = BOBGUI_SELECTION_MODEL (bobgui_multi_selection_new (model));
  else
    {
      impl->selection_model = BOBGUI_SELECTION_MODEL (bobgui_single_selection_new (model));
      bobgui_single_selection_set_can_unselect (BOBGUI_SINGLE_SELECTION (impl->selection_model), TRUE);
      bobgui_single_selection_set_autoselect (BOBGUI_SINGLE_SELECTION (impl->selection_model), FALSE);
    }
  ...
  bobgui_column_view_set_model (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view),
                             BOBGUI_SELECTION_MODEL (impl->selection_model));
...
static void
put_recent_folder_in_pathbar (BobguiFileChooserWidget *impl,
                              guint                 position)
{
  GFileInfo *info;
  ...
  _bobgui_path_bar_set_file (BOBGUI_PATH_BAR (impl->browse_path_bar),
                          _bobgui_file_info_get_file (info),
                          FALSE);
 ...
 */
static void
location_bar_update (BobguiFileChooserWidget *impl)
{
      ...
      if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
        {
          ...
          if (bobgui_bitset_iter_init_first (&iter, bitset, &position))
  ...
  bobgui_widget_set_visible (impl->browse_new_folder_button, create_folder_visible);
}

static void
search_clear_engine (BobguiFileChooserWidget *impl)
{
...
static void
operation_mode_stop (BobguiFileChooserWidget *impl,
                     OperationMode         mode)
{
  if (mode == OPERATION_MODE_SEARCH)
    {
      ...
      bobgui_widget_set_visible (impl->remote_warning_bar, FALSE);
      search_clear_engine (impl);
    }
}

static void
operation_mode_set_enter_location (BobguiFileChooserWidget *impl)
{
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_files_stack), "list");
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_header_stack), "location");
  bobgui_revealer_set_reveal_child (BOBGUI_REVEALER (impl->browse_header_revealer), TRUE);
  location_bar_update (impl);
  bobgui_widget_set_sensitive (impl->filter_combo, TRUE);
  location_mode_set (impl, LOCATION_MODE_FILENAME_ENTRY);
}

static void
operation_mode_set_browse (BobguiFileChooserWidget *impl)
{
  BobguiRevealerTransitionType old_revealer_transition_type;
  ...
  old_revealer_transition_type = bobgui_revealer_get_transition_type (BOBGUI_REVEALER (impl->browse_header_revealer));
  bobgui_revealer_set_transition_type (BOBGUI_REVEALER (impl->browse_header_revealer),
...
static void
operation_mode_set_search (BobguiFileChooserWidget *impl)
{
  BobguiWidget *visible_widget;

  g_assert (impl->search_model == NULL);

  visible_widget = bobgui_stack_get_visible_child (BOBGUI_STACK (impl->browse_files_stack));
  ...
  bobgui_widget_grab_focus (impl->search_entry);
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_header_stack), "search");
  bobgui_revealer_set_reveal_child (BOBGUI_REVEALER (impl->browse_header_revealer), TRUE);
  location_bar_update (impl);
  search_setup_widgets (impl);
  bobgui_widget_set_sensitive (impl->filter_combo, FALSE);
}

static void
operation_mode_set_recent (BobguiFileChooserWidget *impl)
{
  GFile *file;
  BobguiRevealerTransitionType old_revealer_transition_type;

  if (!impl->recent_manager)
    impl->recent_manager = bobgui_recent_manager_get_default ();
  ...
  _bobgui_path_bar_set_file (BOBGUI_PATH_BAR (impl->browse_path_bar), file, FALSE);
  bobgui_places_sidebar_set_location (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), file);
  g_object_notify (G_OBJECT (impl), "subtitle");
  g_object_unref (file);
  bobgui_widget_set_sensitive (impl->filter_combo, TRUE);
}
...
static void
operation_mode_set_other_locations (BobguiFileChooserWidget *impl)
{
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_files_stack), "other_locations");
  bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_header_stack), "pathbar");
  bobgui_revealer_set_reveal_child (BOBGUI_REVEALER (impl->browse_header_revealer), FALSE);
  location_bar_update (impl);
...
static void
operation_mode_set (BobguiFileChooserWidget *impl, OperationMode mode)
{
 ...
 */
static void
update_appearance (BobguiFileChooserWidget *impl)
{
  if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
    {
      save_widgets_create (impl);
      bobgui_places_sidebar_set_show_recent (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), FALSE);
  ...
  else if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
           impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
    {
      save_widgets_destroy (impl);
      bobgui_places_sidebar_set_show_recent (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), recent_files_setting_is_enabled (impl));
...
static char *
bobgui_file_chooser_widget_get_subtitle (BobguiFileChooserWidget *impl)
{
  char *subtitle = NULL;
  ...
  if (impl->operation_mode == OPERATION_MODE_SEARCH)
    {
      ...
      location = bobgui_places_sidebar_get_location_title (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar));
      if (location)
        {
...
static void
set_show_hidden (BobguiFileChooserWidget *impl,
                 gboolean              show_hidden)
{
  if (impl->show_hidden != show_hidden)
    {
      ...
      if (impl->browse_files_model)
        _bobgui_file_system_model_set_show_hidden (impl->browse_files_model, show_hidden);
...
static void
bobgui_file_chooser_widget_set_property (GObject      *object,
                                      guint         prop_id,
                                      const GValue *value,
                                      GParamSpec   *pspec)
  ...
  switch (prop_id)
    ...
    case PROP_SEARCH_MODE:
      if (g_value_get_boolean (value))
        ...
        {
          if (bobgui_stack_get_visible_child (BOBGUI_STACK (impl->browse_files_stack)) != impl->places_view)
            {
              operation_mode_set (impl, OPERATION_MODE_BROWSE);
    ...
    case BOBGUI_FILE_CHOOSER_PROP_ACTION:
      {
        BobguiFileChooserAction action = g_value_get_enum (value);

        if (action != impl->action)
          {
            bobgui_file_chooser_widget_unselect_all (BOBGUI_FILE_CHOOSER (impl));
    ...
    case BOBGUI_FILE_CHOOSER_PROP_SELECT_MULTIPLE:
      {
    ...
    case BOBGUI_FILE_CHOOSER_PROP_CREATE_FOLDERS:
      {
...
static void
bobgui_file_chooser_widget_get_property (GObject    *object,
                                       guint       prop_id,
                                       GValue     *value,
                                       GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_SUBTITLE:
      g_value_take_string (value, bobgui_file_chooser_widget_get_subtitle (impl));
      break;
    ...
    case BOBGUI_FILE_CHOOSER_PROP_FILTERS:
      g_value_set_object (value, impl->filters);
      break;

    case BOBGUI_FILE_CHOOSER_PROP_SHORTCUT_FOLDERS:
      g_value_take_object (value, bobgui_file_chooser_get_shortcut_folders (BOBGUI_FILE_CHOOSER (impl)));
      break;
...
static void
cancel_all_operations (BobguiFileChooserWidget *impl)
{
...
static void sorter_changed (BobguiSorter            *main_sorter,
                            GParamSpec           *pspec,
                            BobguiFileChooserWidget *impl);

static void
bobgui_file_chooser_widget_dispose (GObject *object)
{
  BobguiFileChooserWidget *impl = (BobguiFileChooserWidget *) object;
  BobguiSorter *sorter;

  cancel_all_operations (impl);

  sorter = bobgui_column_view_get_sorter (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view));
  g_signal_handlers_disconnect_by_func (sorter, G_CALLBACK (sorter_changed), impl);

  /* browse_files_popover is not a template child */
  g_clear_pointer (&impl->browse_files_popover, bobgui_widget_unparent);
  g_clear_pointer (&impl->bookmarks_manager, _bobgui_bookmarks_manager_free);
  ...
  bobgui_widget_dispose_template (BOBGUI_WIDGET (impl), BOBGUI_TYPE_FILE_CHOOSER_WIDGET);

  G_OBJECT_CLASS (bobgui_file_chooser_widget_parent_class)->dispose (object);
}

/* Handler for BobguiWindow::set-focus; this is where we save the last-focused
 * widget on our toplevel.  See bobgui_file_chooser_widget_hierarchy_changed()
 */
static void
toplevel_set_focus_cb (BobguiWindow            *window,
                       GParamSpec           *pspec,
                       BobguiFileChooserWidget *impl)
{
  impl->toplevel_last_focus_widget = impl->toplevel_current_focus_widget;
  impl->toplevel_current_focus_widget = bobgui_root_get_focus (BOBGUI_ROOT (window));
}
 ...
 */
static void
bobgui_file_chooser_widget_root (BobguiWidget *widget)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (widget);
  BobguiWidget *toplevel;

  BOBGUI_WIDGET_CLASS (bobgui_file_chooser_widget_parent_class)->root (widget);
  ...
  impl->toplevel_current_focus_widget = bobgui_root_get_focus (BOBGUI_ROOT (toplevel));
}

static void
bobgui_file_chooser_widget_unroot (BobguiWidget *widget)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (widget);
  BobguiWidget *toplevel;
  ...
  BOBGUI_WIDGET_CLASS (bobgui_file_chooser_widget_parent_class)->unroot (widget);
}

static void
settings_load (BobguiFileChooserWidget *impl)
{
  gboolean show_hidden;
  ...
  settings = _bobgui_file_chooser_get_settings_for_widget (BOBGUI_WIDGET (impl));
  ...
  if (sidebar_width < 0)
    {
      BobguiWidget *sidebar = bobgui_paned_get_start_child (BOBGUI_PANED (impl->browse_widgets_hpaned));

      bobgui_widget_measure (sidebar, BOBGUI_ORIENTATION_HORIZONTAL, -1,
                          NULL, &sidebar_width, NULL, NULL);
    }

  bobgui_paned_set_position (BOBGUI_PANED (impl->browse_widgets_hpaned), sidebar_width);
}

static void
settings_save (BobguiFileChooserWidget *impl)
{
  GSettings *settings;
  ...
  g_settings_set_int (settings, SETTINGS_KEY_SIDEBAR_WIDTH,
                      bobgui_paned_get_position (BOBGUI_PANED (impl->browse_widgets_hpaned)));
...
static void
switch_to_cwd (BobguiFileChooserWidget *impl)
{
  char *current_working_dir = g_get_current_dir ();
  GFile *cwd = g_file_new_for_path (current_working_dir);

  bobgui_file_chooser_set_current_folder (BOBGUI_FILE_CHOOSER (impl), cwd, NULL);
...
static gboolean
recent_files_setting_is_enabled (BobguiFileChooserWidget *impl)
{
  BobguiSettings *settings;
  gboolean enabled;

  settings = bobgui_widget_get_settings (BOBGUI_WIDGET (impl));
 ...
 */
static void
set_startup_mode (BobguiFileChooserWidget *impl)
{
  BobguiRevealerTransitionType revealer_transition;
  BobguiStackTransitionType stack_transition;

  /* turn off animations for this setup */
  revealer_transition
    = bobgui_revealer_get_transition_type (BOBGUI_REVEALER (impl->browse_header_revealer));
  bobgui_revealer_set_transition_type (BOBGUI_REVEALER (impl->browse_header_revealer),
                                    BOBGUI_REVEALER_TRANSITION_TYPE_NONE);
  stack_transition
    = bobgui_stack_get_transition_type (BOBGUI_STACK (impl->browse_header_stack));
  bobgui_stack_set_transition_type (BOBGUI_STACK (impl->browse_header_stack),
                                 BOBGUI_STACK_TRANSITION_TYPE_NONE);

  switch (impl->startup_mode)
    {
    case STARTUP_MODE_RECENT:
      if (bobgui_places_sidebar_get_show_recent (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar)))
        {
          operation_mode_set (impl, OPERATION_MODE_RECENT);
          break;
        }
...
static gboolean
shortcut_exists (BobguiFileChooserWidget *impl, GFile *needle)
{
  GListModel *haystack;
  guint n, i;
  gboolean exists;
  ...
  haystack = bobgui_places_sidebar_get_shortcuts (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar));
...
static void
add_cwd_to_sidebar_if_needed (BobguiFileChooserWidget *impl)
{
  char *cwd;
  GFile *cwd_file;
  GFile *home_file;
  ...
  if (!g_file_equal (home_file, cwd_file))
    bobgui_places_sidebar_add_shortcut (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), cwd_file);
...
/* BobguiWidget::map method */
static void
bobgui_file_chooser_widget_map (BobguiWidget *widget)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (widget);

  impl->browse_files_interaction_frozen = FALSE;

  BOBGUI_WIDGET_CLASS (bobgui_file_chooser_widget_parent_class)->map (widget);
...
/* BobguiWidget::unmap method */
static void
bobgui_file_chooser_widget_unmap (BobguiWidget *widget)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (widget);
  ...
  BOBGUI_WIDGET_CLASS (bobgui_file_chooser_widget_parent_class)->unmap (widget);
}

static void
set_busy_cursor (BobguiFileChooserWidget *impl,
                 gboolean               busy)
{
  BobguiWidget *widget;
  BobguiWindow *toplevel;
...
static void
update_columns (BobguiFileChooserWidget *impl,
                gboolean              location_visible,
                const char           *time_title)
{
  bobgui_column_view_column_set_visible (impl->column_view_location_column, location_visible);
  bobgui_column_view_column_set_title (impl->column_view_time_column, time_title);
}

/* Creates a sort model to wrap the file system model and sets it on the tree view */
static void
load_set_model (BobguiFileChooserWidget *impl)
{
...
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (data);
...
static void
load_setup_timer (BobguiFileChooserWidget *impl)
{
  g_assert (impl->load_timeout_id == 0);
  g_assert (impl->load_state != LOAD_PRELOAD);

  impl->load_timeout_id = g_timeout_add (MAX_LOADING_TIME, load_timeout_cb, impl);
  gdk_source_set_static_name_by_id (impl->load_timeout_id, "[bobgui] load_timeout_cb");
  impl->load_state = LOAD_PRELOAD;
}

/* Removes the load timeout; changes the impl->load_state to the specified value. */
static void
load_remove_timer (BobguiFileChooserWidget *impl, LoadState new_load_state)
{
...
static gboolean
show_and_select_files (BobguiFileChooserWidget *impl,
                       GSList               *files)
{
  BobguiFileSystemModel *fsmodel;
  ...
  fsmodel = BOBGUI_FILE_SYSTEM_MODEL (get_current_model (impl));
  ...
  for (walk = files; walk; walk = walk->next)
    {
      ...
      info = _bobgui_file_system_model_get_info_for_file (fsmodel, file);
      if (!info)
        continue;
      ...
      for (i = 0; i < g_list_model_get_n_items (G_LIST_MODEL (impl->selection_model)); i++)
        {
          ...
          if (info2 == info)
            {
              bobgui_column_view_scroll_to (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view), i, FALSE,
                                         BOBGUI_LIST_SCROLL_SELECT | BOBGUI_LIST_SCROLL_FOCUS, FALSE);
...
static void
pending_select_files_process (BobguiFileChooserWidget *impl)
{
  g_assert (impl->load_state == LOAD_FINISHED);
  g_assert (impl->browse_files_model != NULL);
  ...
  if (impl->pending_select_files)
  ...
  else
    {
       ...
       * but rather on behalf of something else like BobguiFileChooserButton.  In
       * that case, the chooser's selection should be what the caller expects,
       * as the user can't see that something else got selected.  See bug #165264.
       */
      if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN &&
          bobgui_widget_get_mapped (BOBGUI_WIDGET (impl)))
        bobgui_selection_model_select_item (impl->selection_model, 0, TRUE);
    }
...
static void
show_error_on_reading_current_folder (BobguiFileChooserWidget *impl, GError *error)
{
  GFileInfo *info;
  char *msg;
...
static void
browse_files_model_finished_loading_cb (BobguiFileSystemModel   *model,
                                        GError               *error,
                                        BobguiFileChooserWidget *impl)
{
  if (error)
...
static void
stop_loading_and_clear_list_model (BobguiFileChooserWidget *impl,
                                   gboolean              remove)
{
...
static char *
my_g_format_date_for_display (BobguiFileChooserWidget *impl,
                              glong                 secs)
{
  GDateTime *now, *time;
...
static char *
my_g_format_time_for_display (BobguiFileChooserWidget *impl,
                              glong                 secs)
{
  GDateTime *time;
  const char *format;
...
static char *
get_type_information (BobguiFileChooserWidget *impl,
                      GFileInfo            *info)
{
...
static gboolean
set_list_model (BobguiFileChooserWidget  *impl,
                GError               **error)
{
  g_assert (impl->current_folder != NULL);

  if (impl->browse_files_model &&
      _bobgui_file_system_model_get_directory (impl->browse_files_model) == impl->current_folder)
    return TRUE;
  ...
  impl->browse_files_model =
    _bobgui_file_system_model_new_for_directory (impl->current_folder, MODEL_ATTRIBUTES);

  _bobgui_file_system_model_set_show_hidden (impl->browse_files_model, impl->show_hidden);
  _bobgui_file_system_model_set_can_select_files (impl->browse_files_model, impl->action != BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER);
  ...
  _bobgui_file_system_model_set_filter (impl->browse_files_model, impl->current_filter);
...
static void
update_chooser_entry (BobguiFileChooserWidget *impl)
{
  BobguiBitsetIter iter;
  BobguiBitset *bitset;
  guint n_selected;
  ...
  n_selected = 0;
  if (bobgui_bitset_iter_init_first (&iter, bitset, &first))
    {
      n_selected++;
      while (bobgui_bitset_iter_next (&iter, NULL))
        n_selected++;
    }
  ...
  if (n_selected == 0)
    {
      if (impl->operation_mode == OPERATION_MODE_RECENT)
        _bobgui_file_chooser_entry_set_base_folder (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), NULL);
      else
      ...
      if (impl->operation_mode == OPERATION_MODE_BROWSE)
        {
          ...
          if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
              impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
            {
              ...
              change_entry = !_bobgui_file_info_consider_as_directory (info);
            }
          else
          ...
          if (change_entry && !impl->auto_selecting_first_row)
            {
              ...
              bobgui_file_chooser_entry_set_text (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), impl->browse_files_last_selected_name);

              g_signal_handlers_unblock_by_func (impl->location_entry, G_CALLBACK (location_entry_changed_cb), impl);

              if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
                _bobgui_file_chooser_entry_select_filename (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry));
            }
               ...
               && impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
        {
          ...
          info = g_list_model_get_item (G_LIST_MODEL (impl->selection_model), first);
          folder = _bobgui_file_info_get_file (info);
          g_clear_object (&info);

          _bobgui_file_chooser_entry_set_base_folder (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), folder);
          return;
        }
    }
  else
    {
      g_assert (impl->action != BOBGUI_FILE_CHOOSER_ACTION_SAVE);
      ...
      g_signal_handlers_block_by_func (impl->location_entry, G_CALLBACK (location_entry_changed_cb), impl);
      bobgui_editable_set_text (BOBGUI_EDITABLE (impl->location_entry), "");
      g_signal_handlers_unblock_by_func (impl->location_entry, G_CALLBACK (location_entry_changed_cb), impl);
      return;
    }
 ...
 maybe_clear_entry:
  ...
  if ((impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN || impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
      && impl->browse_files_last_selected_name)
    {
      ...
      entry_text = bobgui_editable_get_text (BOBGUI_EDITABLE (impl->location_entry));
...
static gboolean
bobgui_file_chooser_widget_set_current_folder (BobguiFileChooser  *chooser,
                                             GFile          *file,
                                             GError        **error)
{
  return bobgui_file_chooser_widget_update_current_folder (chooser, file, FALSE, FALSE, error);
}
                                   ...
                                   gpointer      user_data)
{
      ...
      if (g_error_matches (error, G_IO_ERROR, G_IO_ERROR_NOT_MOUNTED))
        {
          ...
          g_clear_error (&error);
          toplevel = BOBGUI_WIDGET (bobgui_widget_get_root (BOBGUI_WIDGET (impl)));

          mount_operation = bobgui_mount_operation_new (BOBGUI_WINDOW (toplevel));
  ...
  _bobgui_path_bar_set_file (BOBGUI_PATH_BAR (impl->browse_path_bar), data->file, data->keep_trail);
  ...
  if (impl->location_entry)
    {
      _bobgui_file_chooser_entry_set_base_folder (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry),
                                               impl->current_folder);
...
static gboolean
bobgui_file_chooser_widget_update_current_folder (BobguiFileChooser  *chooser,
                                               GFile          *file,
                                               gboolean        keep_trail,
                                               gboolean        clear_entry,
                                               GError        **error)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
...
static GFile *
bobgui_file_chooser_widget_get_current_folder (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
...
static void
bobgui_file_chooser_widget_set_current_name (BobguiFileChooser *chooser,
                                          const char     *name)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  g_return_if_fail (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE);

  pending_select_files_free (impl);

  bobgui_file_chooser_entry_set_text (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), name);
}

static char *
bobgui_file_chooser_widget_get_current_name (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  g_return_val_if_fail (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE, NULL);

  return g_strdup (bobgui_editable_get_text (BOBGUI_EDITABLE (impl->location_entry)));
}

static gboolean
bobgui_file_chooser_widget_select_file (BobguiFileChooser  *chooser,
                                     GFile           *file,
                                     GError         **error)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  ...
  if (!parent_file)
    return bobgui_file_chooser_set_current_folder (chooser, file, error);
  ...
  if (!same_path)
    {
      ...
      result = bobgui_file_chooser_set_current_folder (chooser, parent_file, error);
      g_object_unref (parent_file);
      return result;
    }
...
static void
bobgui_file_chooser_widget_unselect_file (BobguiFileChooser *chooser,
                                       GFile          *file)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  BobguiBitsetIter iter;
  ...
  for (bobgui_bitset_iter_init_first (&iter, bitset, &i);
       ...
       bobgui_bitset_iter_next (&iter, &i))
    {
      ...
      info = g_list_model_get_item (G_LIST_MODEL (impl->selection_model), i);
      f = _bobgui_file_info_get_file (info);
      g_clear_object (&info);
  ...
  if (bobgui_bitset_iter_is_valid (&iter))
    bobgui_selection_model_unselect_item (impl->selection_model, i);

  g_clear_pointer (&bitset, bobgui_bitset_unref);
}

static void
bobgui_file_chooser_widget_select_all (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  ...
  if (impl->operation_mode == OPERATION_MODE_SEARCH ||
      impl->operation_mode == OPERATION_MODE_RECENT)
    {
      bobgui_selection_model_select_all (impl->selection_model);
      return;
    }
      ...
      for (i = 0; i < g_list_model_get_n_items (G_LIST_MODEL (impl->selection_model)); i++)
        {
          ...
          if ((is_folder && impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER) ||
              (!is_folder && impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN))
            bobgui_selection_model_select_item (impl->selection_model, i, FALSE);
          else
            bobgui_selection_model_unselect_item (impl->selection_model, i);
...
static void
bobgui_file_chooser_widget_unselect_all (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  bobgui_selection_model_unselect_all (impl->selection_model);
  pending_select_files_free (impl);
}

/* Checks whether the filename entry for Save modes contains a well-formed filename.
 *
 * is_well_formed_ret - whether what the user typed passes bobgui_file_system_make_path()
 *
 ...
 */
static void
check_save_entry (BobguiFileChooserWidget  *impl,
                  GFile                **file_ret,
                  ...
                  gboolean              *is_folder)
{
  ...
  chooser_entry = BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry);

  if (strlen (bobgui_editable_get_text (BOBGUI_EDITABLE (chooser_entry))) == 0)
    {
      *file_ret = NULL;
  ...
  *is_empty_ret = FALSE;
  ...
  current_folder = _bobgui_file_chooser_entry_get_current_folder (chooser_entry);
  if (!current_folder)
    {
      *file_ret = NULL;
  ...
  file_part = _bobgui_file_chooser_entry_get_file_part (chooser_entry);
  ...
  *file_ret = file;
  *is_well_formed_ret = TRUE;
  *is_folder = _bobgui_file_chooser_entry_get_is_folder (chooser_entry, file);
}

static GListModel *
get_selected_files_as_model (BobguiFileChooserWidget *impl)
{
  GListStore *store;
  GSList *files, *l;

  store = g_list_store_new (G_TYPE_FILE);
  files = bobgui_file_chooser_widget_get_selected_files (impl);
  for (l = files; l; l = l->next)
...
static GListModel *
bobgui_file_chooser_widget_get_files (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  GListStore *result;
  BobguiWindow *toplevel;
      ...
      if (g_list_model_get_n_items (G_LIST_MODEL (result)) == 0 && impl->location_entry)
        goto file_entry;
           ...
           (current_focus == impl->location_entry ||
            bobgui_widget_is_ancestor (current_focus, impl->location_entry)))
    {
 ...
 out:
  ...
  if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER &&
      g_list_model_get_n_items (G_LIST_MODEL (result)) == 0)
    {
      ...
      current_folder = bobgui_file_chooser_get_current_folder (chooser);
...
static void
update_show_filters (BobguiFileChooserWidget *impl)
{
  bobgui_widget_set_visible (impl->filter_combo_hbox,
                          g_list_model_get_n_items (G_LIST_MODEL (impl->filters)) > 0);
  update_extra_and_filters (impl);
}

static void
bobgui_file_chooser_widget_add_filter (BobguiFileChooser *chooser,
                                    BobguiFileFilter  *filter)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  ...
  if (g_list_store_find (impl->filters, filter, NULL))
    {
      g_warning ("bobgui_file_chooser_add_filter() called on filter already in list");
      return;
    }
...
static void
bobgui_file_chooser_widget_remove_filter (BobguiFileChooser *chooser,
                                       BobguiFileFilter  *filter)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  guint filter_index;
  ...
  if (!g_list_store_find (impl->filters, filter, &filter_index))
    {
      g_warning ("bobgui_file_chooser_remove_filter() called on filter not in list");
      return;
    }
  ...
  if (filter == impl->current_filter)
    {
      if (impl->filters)
        {
          BobguiFileFilter *f = g_list_model_get_item (G_LIST_MODEL (impl->filters), 0);
...
static GListModel *
bobgui_file_chooser_widget_get_filters (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
...
static gboolean
bobgui_file_chooser_widget_add_shortcut_folder (BobguiFileChooser  *chooser,
                                             GFile           *file,
                                             GError         **error)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  bobgui_places_sidebar_add_shortcut (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), file);
...
static gboolean
bobgui_file_chooser_widget_remove_shortcut_folder (BobguiFileChooser  *chooser,
                                                GFile           *file,
                                                GError         **error)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  bobgui_places_sidebar_remove_shortcut (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), file);
...
static GListModel *
bobgui_file_chooser_widget_get_shortcut_folders (BobguiFileChooser *chooser)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);

  return bobgui_places_sidebar_get_shortcuts (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar));
}

/* Changes to the selected folder in the list view */
static void
switch_to_selected_folder (BobguiFileChooserWidget *impl)
{
  BobguiBitsetIter iter;
  BobguiBitset *bitset;
  unsigned int i;
 ...
 */
static const char *
get_display_name_from_file_list (BobguiFileChooserWidget *impl)
{
  GFileInfo *info;

  g_assert (!impl->select_multiple);
  g_assert (BOBGUI_IS_SINGLE_SELECTION (impl->selection_model));

  info = bobgui_single_selection_get_selected_item (BOBGUI_SINGLE_SELECTION (impl->selection_model));
  g_assert (info != NULL);
 ...
 */
static void
request_response_and_add_to_recent_list (BobguiFileChooserWidget *impl)
{
  bobgui_widget_activate_action (BOBGUI_WIDGET (impl), "response.activate", NULL);
...
static void
confirm_dialog_should_accept_filename (BobguiFileChooserWidget *impl,
                                       const char            *file_part,
                                       const char            *folder_display_name)
{
  ...
  dialog = bobgui_alert_dialog_new (_("A file named “%s” already exists.  Do you want to replace it?"),
                                 file_part);
  ...
  bobgui_alert_dialog_set_buttons (dialog, (const char *[]) { _("_Cancel"), _("_Replace"), NULL });
  bobgui_alert_dialog_set_cancel_button (dialog, 0);
  bobgui_alert_dialog_set_default_button (dialog, 1);
  bobgui_alert_dialog_choose (dialog, toplevel, NULL, on_confirm_overwrite_response, impl);
  g_object_unref (dialog);
}
 ...
 */
static gboolean
should_respond_after_confirm_overwrite (BobguiFileChooserWidget *impl,
                                        const char           *file_part,
                                        GFile                *parent_file)
{
                               ...
                               gpointer      user_data)
{
  ...
  if (info)
    {
      parent_is_folder = _bobgui_file_info_consider_as_directory (info);
  ...
  if (parent_is_folder && parent_is_accessible)
    {
      ...
      else if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
        {
          if (data->file_exists_and_is_not_folder)
            {
               ...
               */
              file_part = g_strdup (_bobgui_file_chooser_entry_get_file_part (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry)));
      ...
      else if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER)
        {
                         ...
                         gpointer      user_data)
{
  ...
  is_folder = (file_exists && _bobgui_file_info_consider_as_directory (info));
                     ...
                     gpointer      data)
{
  ...
  if (!bobgui_file_chooser_widget_select_file (BOBGUI_FILE_CHOOSER (impl), file, NULL))
...
static void
location_popup_on_paste_handler (BobguiFileChooserWidget *impl)
{
  GdkClipboard *clipboard = bobgui_widget_get_clipboard (BOBGUI_WIDGET (impl));
...
/* Implementation for BobguiFileChooserEmbed::should_respond() */
static gboolean
recent_should_respond (BobguiFileChooserWidget *impl)
{
...
static void
add_selection_to_recent_list (BobguiFileChooserWidget *impl)
{
  GListModel *files;
  guint i, n;

  files = bobgui_file_chooser_widget_get_files (BOBGUI_FILE_CHOOSER (impl));
  ...
  for (i = 0; i < n; i++)
    {
      ...
      if (uri)
        {
          bobgui_recent_manager_add_item (impl->recent_manager, uri);
          g_free (uri);
        }
...
gboolean
bobgui_file_chooser_widget_should_respond (BobguiFileChooserWidget *impl)
{
  BobguiWidget *toplevel;
  BobguiWidget *current_focus;
  gboolean retval;
  ...
  toplevel = BOBGUI_WIDGET (bobgui_widget_get_root (BOBGUI_WIDGET (impl)));
  g_assert (BOBGUI_IS_WINDOW (toplevel));
  ...
  if (current_focus == get_current_view_widget (impl))
    ...
    file_list:
      ...
      g_assert (impl->action >= BOBGUI_FILE_CHOOSER_ACTION_OPEN && impl->action <= BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER);
    ...
    save_entry:
      ...
      entry = BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry);
      ...
      if (!is_well_formed)
        {
          if (!is_empty &&
              ...
              impl->operation_mode == OPERATION_MODE_RECENT)
            {
               ...
               */
              bobgui_widget_grab_focus (impl->browse_files_tree_view);
#endif
            }
      ...
      if (is_folder)
      ...
      else
        {
           ...
           * the BobguiFileChooserEntry *does* report is_folder==FALSE as a false
          ...
          data->impl = g_object_ref (impl);
          data->file = g_object_ref (file);
          data->parent_file = _bobgui_file_chooser_entry_get_current_folder (entry);
...
void
bobgui_file_chooser_widget_initial_focus (BobguiFileChooserWidget *impl)
{
  BobguiWidget *widget;
...
/* Callback used from BobguiSearchEngine when we get new hits */
static void
search_engine_hits_added_cb (BobguiSearchEngine      *engine,
                             GList                *hits,
                             BobguiFileChooserWidget *impl)
{
  ...
  for (l = hits; l; l = l->next)
    {
      BobguiSearchHit *hit = (BobguiSearchHit *)l->data;
  ...
  _bobgui_file_system_model_update_files (impl->search_model,
                                       files_with_info, infos);
  _bobgui_file_system_model_add_and_query_files (impl->search_model,
...
/* Callback used from BobguiSearchEngine when the query is done running */
static void
search_engine_finished_cb (BobguiSearchEngine *engine,
                           ...
                           gpointer         data)
{
  ...
  set_busy_cursor (impl, FALSE);
  bobgui_widget_set_visible (impl->search_spinner, FALSE);
  ...
  if (!got_results)
    {
      bobgui_stack_set_visible_child_name (BOBGUI_STACK (impl->browse_files_stack), "empty");
      bobgui_widget_grab_focus (impl->search_entry);
    }
}

static void
search_engine_error_cb (BobguiSearchEngine *engine,
                        const char      *message,
                        gpointer         data)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (data);
...
static void
search_clear_model (BobguiFileChooserWidget *impl,
                    gboolean              remove)
{
  if (!impl->search_model)
    return;
...
static void
search_stop_searching (BobguiFileChooserWidget *impl,
                       gboolean              remove_query)
{
  if (remove_query && impl->search_entry)
    {
      bobgui_editable_set_text (BOBGUI_EDITABLE (impl->search_entry), "");
    }

  if (impl->search_engine)
    {
      _bobgui_search_engine_stop (impl->search_engine);
...
static void
search_setup_model (BobguiFileChooserWidget *impl)
{
  g_assert (impl->search_model == NULL);

  impl->search_model = _bobgui_file_system_model_new ();

  _bobgui_file_system_model_set_can_select_files (impl->search_model, impl->action != BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER);
...
show_spinner (gpointer data)
{
  ...
  bobgui_widget_set_visible (impl->search_spinner, TRUE);
  bobgui_spinner_start (BOBGUI_SPINNER (impl->search_spinner));
  impl->show_progress_timeout = 0;
...
static void
search_start_query (BobguiFileChooserWidget *impl,
                    const char           *query_text)
{
  ...
  gdk_source_set_static_name_by_id (impl->show_progress_timeout, "[bobgui] show_spinner");

  if (impl->search_engine == NULL)
    impl->search_engine = _bobgui_search_engine_new ();

  if (!impl->search_query)
    {
      impl->search_query = bobgui_query_new ();
      bobgui_query_set_text (impl->search_query, query_text);
    }

  file = bobgui_places_sidebar_get_location (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar));
  if (file)
    {
      bobgui_query_set_location (impl->search_query, file);
      g_object_unref (file);
    }
  else
    bobgui_query_set_location (impl->search_query, impl->current_folder);

  _bobgui_search_engine_set_model (impl->search_engine, impl->model_for_search);
  _bobgui_search_engine_set_query (impl->search_engine, impl->search_query);
  ...
  _bobgui_search_engine_start (impl->search_engine);

  if (bobgui_query_get_location (impl->search_query) &&
      _bobgui_file_consider_as_remote (bobgui_query_get_location (impl->search_query)))
    bobgui_widget_set_visible (impl->remote_warning_bar, TRUE);

  /* We're not showing the file list here already and instead rely on the
   * BobguiSearchEntry timeout and the ::hits-added signal from above to
   * switch. */
}
 ...
 */
static void
search_entry_activate_cb (BobguiFileChooserWidget *impl)
{
  const char *text;
  ...
  text = bobgui_editable_get_text (BOBGUI_EDITABLE (impl->search_entry));

  /* reset any existing query object */
  g_set_object (&impl->search_query, NULL);

  bobgui_places_view_set_search_query (BOBGUI_PLACES_VIEW (impl->places_view), text);
...
static void
search_entry_stop_cb (BobguiFileChooserWidget *impl)
{
  if (impl->search_engine)
    {
      search_stop_searching (impl, FALSE);
...
static void
search_setup_widgets (BobguiFileChooserWidget *impl)
{
  ...
  if (impl->search_query)
    {
      ...
      query = bobgui_query_get_text (impl->search_query);
      if (query)
        {
          bobgui_editable_set_text (BOBGUI_EDITABLE (impl->search_entry), query);
...
static void
recent_clear_model (BobguiFileChooserWidget *impl,
                    gboolean              remove)
{
  if (!impl->recent_model)
    return;
...
static void
recent_start_loading (BobguiFileChooserWidget *impl)
{
  GList *items;
  ...
  impl->recent_model = _bobgui_file_system_model_new ();

  _bobgui_file_system_model_set_filter (impl->recent_model, impl->current_filter);
  _bobgui_file_system_model_set_can_select_files (impl->recent_model, impl->action != BOBGUI_FILE_CHOOSER_ACTION_SELECT_FOLDER);

  if (!impl->recent_manager)
    return;

  items = bobgui_recent_manager_get_items (impl->recent_manager);
  if (!items)
    return;
  ...
  if (impl->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN)
    {
      ...
      for (l = items; l; l = l->next)
        {
          ...
          if (bobgui_recent_info_get_private_hint (info) &&
              !bobgui_recent_info_has_application (info, app_name))
            continue;

          file = g_file_new_for_uri (bobgui_recent_info_get_uri (info));
          files = g_list_prepend (files, file);
      ...
      _bobgui_file_system_model_add_and_query_files (impl->recent_model,
                                                  files,
                                                  MODEL_ATTRIBUTES);
      g_list_free_full (files, g_object_unref);
  ...
  else
    {
      ...
      folders = _bobgui_file_chooser_extract_recent_folders (items);
      _bobgui_file_system_model_add_and_query_files (impl->recent_model,
                                                  folders,
                                                  MODEL_ATTRIBUTES);
  ...
  g_list_free_full (items, (GDestroyNotify) bobgui_recent_info_unref);
...
static void
set_current_filter (BobguiFileChooserWidget *impl,
                    BobguiFileFilter        *filter)
{
  if (impl->current_filter != filter)
    {
      ...
      if (filter)
        {
          if (!g_list_store_find (impl->filters, filter, &filter_index))
            filter_index = BOBGUI_INVALID_LIST_POSITION;
        }
      else
        {
          filter_index = -1;
      ...
      bobgui_drop_down_set_selected (BOBGUI_DROP_DOWN (impl->filter_combo), filter_index);
...
static void
filter_combo_changed (BobguiDropDown          *dropdown,
                      GParamSpec           *pspec,
                      BobguiFileChooserWidget *impl)
{
  BobguiFileFilter *new_filter;

  new_filter = bobgui_drop_down_get_selected_item (dropdown);
...
static void
list_selection_changed (BobguiSelectionModel    *selection_model,
                        guint                 position,
                        guint                 n_items,
                        BobguiFileChooserWidget *impl)
{
...
static gboolean
browse_files_view_keynav_failed_cb (BobguiWidget        *widget,
                                    BobguiDirectionType  direction,
                                    gpointer          user_data)
{
 BobguiFileChooserWidget *impl = user_data;

 if (direction == BOBGUI_DIR_UP && impl->operation_mode == OPERATION_MODE_SEARCH)
   {
     bobgui_widget_grab_focus (impl->search_entry);
 ...
 * be either a BobguiColumnView, or a BobguiGridView.
 */
static void
browse_files_view_row_activated_cb (BobguiWidget            *view,
                                    guint                 position,
                                    BobguiFileChooserWidget *self)
{
  GFileInfo *info;
  ...
  if (_bobgui_file_info_consider_as_directory (info))
    {
      GFile *file = _bobgui_file_info_get_file (info);
      change_folder_and_display_error (self, file, FALSE);
    }
  else if (self->action == BOBGUI_FILE_CHOOSER_ACTION_OPEN ||
           self->action == BOBGUI_FILE_CHOOSER_ACTION_SAVE)
    {
      /* prevent recursion */
...
static void
path_bar_clicked (BobguiPathBar           *path_bar,
                  GFile                *file,
                  GFile                *child_file,
                  gboolean              child_is_hidden,
                  BobguiFileChooserWidget *impl)
...
static void
location_set_user_text (BobguiFileChooserWidget *impl,
                        const char           *path)
{
  bobgui_file_chooser_entry_set_text (BOBGUI_FILE_CHOOSER_ENTRY (impl->location_entry), path);
  bobgui_editable_set_position (BOBGUI_EDITABLE (impl->location_entry), -1);
}

static void
location_popup_handler (BobguiFileChooserWidget *impl,
                        const char           *path)
{
  if (impl->operation_mode != OPERATION_MODE_BROWSE)
    {
...
static void
up_folder_handler (BobguiFileChooserWidget *impl)
{
  _bobgui_path_bar_up (BOBGUI_PATH_BAR (impl->browse_path_bar));
}

/* Handler for the "down-folder" keybinding signal */
static void
down_folder_handler (BobguiFileChooserWidget *impl)
{
  _bobgui_path_bar_down (BOBGUI_PATH_BAR (impl->browse_path_bar));
}

/* Handler for the "home-folder" keybinding signal */
static void
home_folder_handler (BobguiFileChooserWidget *impl)
{
  switch_to_home_dir (impl);
}
...
static void
desktop_folder_handler (BobguiFileChooserWidget *impl)
{
  const char *name;
  GFile *file;
  ...
  bobgui_file_chooser_set_current_folder (BOBGUI_FILE_CHOOSER (impl), file, NULL);
  g_object_unref (file);
}

/* Handler for the "search-shortcut" keybinding signal */
static void
search_shortcut_handler (BobguiFileChooserWidget *impl)
{
  if (impl->operation_mode == OPERATION_MODE_SEARCH)
    {
      operation_mode_set (impl, OPERATION_MODE_BROWSE);
...
static void
recent_shortcut_handler (BobguiFileChooserWidget *impl)
{
  operation_mode_set (impl, OPERATION_MODE_RECENT);
}
...
static void
places_shortcut_handler (BobguiFileChooserWidget *impl)
{
  bobgui_widget_child_focus (impl->places_sidebar, BOBGUI_DIR_LEFT);
}

static void
quick_bookmark_handler (BobguiFileChooserWidget *impl,
                        int                   bookmark_index)
{
  GFile *file;

  file = bobgui_places_sidebar_get_nth_bookmark (BOBGUI_PLACES_SIDEBAR (impl->places_sidebar), bookmark_index);
...
static void
show_hidden_handler (BobguiFileChooserWidget *impl)
{
  set_show_hidden (impl, !impl->show_hidden);
}

static void
add_normal_and_shifted_binding (BobguiWidgetClass  *widget_class,
                                guint            keyval,
                                GdkModifierType  modifiers,
...
static void
bobgui_file_chooser_widget_size_allocate (BobguiWidget *widget,
                                       int        width,
                                       int        height,
                                       int        baseline)
{
  ...
  BOBGUI_WIDGET_CLASS (bobgui_file_chooser_widget_parent_class)->size_allocate (widget, width, height, baseline);

  if (impl->browse_files_popover)
    bobgui_popover_present (BOBGUI_POPOVER (impl->browse_files_popover));
  if (impl->rename_file_popover)
    bobgui_popover_present (BOBGUI_POPOVER (impl->rename_file_popover));
}

static void
bobgui_file_chooser_widget_class_init (BobguiFileChooserWidgetClass *class)
{
  ...
  gobject_class->finalize = bobgui_file_chooser_widget_finalize;
  gobject_class->constructed = bobgui_file_chooser_widget_constructed;
  gobject_class->set_property = bobgui_file_chooser_widget_set_property;
  gobject_class->get_property = bobgui_file_chooser_widget_get_property;
  gobject_class->dispose = bobgui_file_chooser_widget_dispose;

  widget_class->map = bobgui_file_chooser_widget_map;
  widget_class->unmap = bobgui_file_chooser_widget_unmap;
  widget_class->root = bobgui_file_chooser_widget_root;
  widget_class->unroot = bobgui_file_chooser_widget_unroot;
  widget_class->size_allocate = bobgui_file_chooser_widget_size_allocate;
  widget_class->grab_focus = bobgui_widget_grab_focus_child;
  widget_class->focus = bobgui_widget_focus_child;

  g_type_ensure (BOBGUI_TYPE_FILE_THUMBNAIL);
  ...
  /**
   * BobguiFileChooserWidget::location-popup:
  ...
  /**
   * BobguiFileChooserWidget::location-popup-on-paste:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
   ...
   * when the user pastes into a `BobguiFileChooserWidget`.
   *
  ...
  /**
   * BobguiFileChooserWidget::location-toggle-popup:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::up-folder:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::down-folder:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::home-folder:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::desktop-folder:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::quick-bookmark:
   * @widget: the object which received the signal
  ...
  /**
   * BobguiFileChooserWidget::show-hidden:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::search-shortcut:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::recent-shortcut:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget::places-shortcut:
   * @widget: the object which received the signal
   *
   * Emitted when the user asks for it.
   *
  ...
  /**
   * BobguiFileChooserWidget:search-mode:
   *
  ...
  /**
   * BobguiFileChooserWidget:subtitle:
   *
  ...
  /**
   * BobguiFileChooserWidget:show-time:
   *
  ...
  bobgui_widget_class_set_template_from_resource (widget_class,
                                               "/org/bobgui/libbobgui/ui/bobguifilechooserwidget.ui");

  /* A *lot* of widgets that we need to handle .... */
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_widgets_hpaned);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_files_stack);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, places_sidebar);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, places_view);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_files_column_view);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_files_grid_view);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_files_swin);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_header_revealer);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_header_stack);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_new_folder_button);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_path_bar_size_group);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_path_bar);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, browse_toggle_view_button);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, filter_combo_hbox);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, filter_combo);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, extra_align);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, extra_and_filters);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, location_entry_box);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, search_entry);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, search_spinner);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, new_folder_name_entry);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, new_folder_create_button);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, new_folder_error_stack);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, new_folder_popover);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, rename_file_name_entry);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, rename_file_rename_button);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, rename_file_error_stack);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, rename_file_popover);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, remote_warning_bar);
  bobgui_widget_class_bind_template_child (widget_class, BobguiFileChooserWidget, box);

  /* And a *lot* of callbacks to bind ... */
  bobgui_widget_class_bind_template_callback (widget_class, browse_files_view_row_activated_cb);
  bobgui_widget_class_bind_template_callback (widget_class, browse_files_view_keynav_failed_cb);
  bobgui_widget_class_bind_template_callback (widget_class, filter_combo_changed);
  bobgui_widget_class_bind_template_callback (widget_class, path_bar_clicked);
  bobgui_widget_class_bind_template_callback (widget_class, places_sidebar_open_location_cb);
  bobgui_widget_class_bind_template_callback (widget_class, places_sidebar_show_error_message_cb);
  bobgui_widget_class_bind_template_callback (widget_class, places_sidebar_show_other_locations_with_flags_cb);
  bobgui_widget_class_bind_template_callback (widget_class, search_entry_activate_cb);
  bobgui_widget_class_bind_template_callback (widget_class, search_entry_stop_cb);
  bobgui_widget_class_bind_template_callback (widget_class, new_folder_popover_active);
  bobgui_widget_class_bind_template_callback (widget_class, new_folder_name_changed);
  bobgui_widget_class_bind_template_callback (widget_class, new_folder_create_clicked);
  bobgui_widget_class_bind_template_callback (widget_class, rename_file_name_changed);
  bobgui_widget_class_bind_template_callback (widget_class, rename_file_rename_clicked);
  bobgui_widget_class_bind_template_callback (widget_class, rename_file_end);
  bobgui_widget_class_bind_template_callback (widget_class, column_view_get_file_display_name);
  bobgui_widget_class_bind_template_callback (widget_class, column_view_get_tooltip_text);
  bobgui_widget_class_bind_template_callback (widget_class, column_view_row_bind);

  bobgui_widget_class_set_css_name (widget_class, I_("filechooser"));

  bobgui_widget_class_set_layout_manager_type (widget_class, BOBGUI_TYPE_BIN_LAYOUT);
}

static gboolean
captured_key (BobguiEventControllerKey *controller,
              guint                  keyval,
              guint                  keycode,
              GdkModifierType        state,
              gpointer               data)
{
  ...
  focus = bobgui_root_get_focus (bobgui_widget_get_root (BOBGUI_WIDGET (impl)));

  ancestor = bobgui_widget_get_ancestor (focus, BOBGUI_TYPE_ACTION_BAR);
  if (ancestor && bobgui_widget_is_ancestor (ancestor, impl->places_view))
    return GDK_EVENT_PROPAGATE;

  if (impl->location_entry)
    {
      if (focus && bobgui_widget_is_ancestor (focus, impl->location_entry))
        return GDK_EVENT_PROPAGATE;
    }

  handled = bobgui_event_controller_key_forward (controller, BOBGUI_WIDGET (impl->search_entry));
...
static void
post_process_ui (BobguiFileChooserWidget *impl)
{
  GFile            *file;
  ...
  target = bobgui_drop_target_new (GDK_TYPE_FILE_LIST, GDK_ACTION_COPY | GDK_ACTION_MOVE);
  g_signal_connect (target, "drop", G_CALLBACK (file_list_drag_drop_cb), impl);
  bobgui_widget_add_controller (impl->browse_files_swin, BOBGUI_EVENT_CONTROLLER (target));

  file = g_file_new_for_path ("/");
  _bobgui_path_bar_set_file (BOBGUI_PATH_BAR (impl->browse_path_bar), file, FALSE);
  g_object_unref (file);

  bobgui_popover_set_default_widget (BOBGUI_POPOVER (impl->new_folder_popover), impl->new_folder_create_button);
  bobgui_popover_set_default_widget (BOBGUI_POPOVER (impl->rename_file_popover), impl->rename_file_rename_button);
  ...
  g_action_map_add_action (G_ACTION_MAP (impl->item_actions), gaction);
  g_object_unref (gaction);
  bobgui_widget_insert_action_group (BOBGUI_WIDGET (impl),
                                  "item",
                                  impl->item_actions);

  bobgui_search_entry_set_key_capture_widget (BOBGUI_SEARCH_ENTRY (impl->search_entry), impl->search_entry);
  ...
  bobgui_widget_add_controller (BOBGUI_WIDGET (impl), controller);

  bobgui_widget_set_parent (impl->rename_file_popover, BOBGUI_WIDGET (impl));
  ...
  action = bobgui_callback_action_new (list_popup_menu_cb, impl, NULL);
  ...
  bobgui_widget_add_controller (BOBGUI_WIDGET (impl->browse_files_column_view), controller);
  ...
  shortcut = bobgui_shortcut_new (trigger, action);
  bobgui_shortcut_controller_add_shortcut (BOBGUI_SHORTCUT_CONTROLLER (controller), shortcut);
  bobgui_widget_add_controller (BOBGUI_WIDGET (impl->browse_files_grid_view), controller);

  controller = bobgui_event_controller_key_new ();
  bobgui_event_controller_set_propagation_phase (controller, BOBGUI_PHASE_CAPTURE);
  g_signal_connect (controller, "key-pressed", G_CALLBACK (files_list_restrict_key_presses), impl);
  bobgui_widget_add_controller (impl->browse_files_column_view, controller);

  controller = bobgui_event_controller_key_new ();
  bobgui_event_controller_set_propagation_phase (controller, BOBGUI_PHASE_CAPTURE);
  g_signal_connect (controller, "key-pressed", G_CALLBACK (files_list_restrict_key_presses), impl);
  bobgui_widget_add_controller (impl->browse_files_grid_view, controller);
}

void
bobgui_file_chooser_widget_set_save_entry (BobguiFileChooserWidget *impl,
                                        BobguiWidget            *entry)
{
  g_return_if_fail (BOBGUI_IS_FILE_CHOOSER_WIDGET (impl));
  g_return_if_fail (entry == NULL || BOBGUI_IS_FILE_CHOOSER_ENTRY (entry));
...
static char *
filter_name (BobguiFileFilter *filter)
{
  return g_strdup (bobgui_file_filter_get_name (filter));
}
                     ...
                     gpointer      user_data)
{
  ...
  if (impl->sort_directories_first)
    {
      gboolean adir = _bobgui_file_info_consider_as_directory ((GFileInfo *)a);
      gboolean bdir = _bobgui_file_info_consider_as_directory ((GFileInfo *)b);
...
static void
sorter_changed (BobguiSorter            *sorter,
                GParamSpec           *pspec,
                BobguiFileChooserWidget *impl)
{
  BobguiColumnViewSorter *main_sorter = BOBGUI_COLUMN_VIEW_SORTER (sorter);
  BobguiColumnViewColumn *primary;

  primary = bobgui_column_view_sorter_get_primary_sort_column (main_sorter);
  impl->sort_column = GPOINTER_TO_INT (g_object_get_data (G_OBJECT (primary), "column"));
  impl->sort_order = bobgui_column_view_sorter_get_primary_sort_order (main_sorter);
}

static void
setup_sorting (BobguiFileChooserWidget *impl)
{
  BobguiFileSystemModel *fsmodel;
  BobguiSorter *main_sorter;
  BobguiSorter *sorter = NULL;

  fsmodel = BOBGUI_FILE_SYSTEM_MODEL (get_current_model (impl));

  main_sorter = bobgui_column_view_get_sorter (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view));
  g_signal_handlers_disconnect_by_func (main_sorter, G_CALLBACK (sorter_changed), impl);

  bobgui_column_view_column_set_sorter (impl->column_view_name_column, NULL);
  bobgui_column_view_column_set_sorter (impl->column_view_location_column, NULL);
  bobgui_column_view_column_set_sorter (impl->column_view_size_column, NULL);
  bobgui_column_view_column_set_sorter (impl->column_view_type_column, NULL);
  bobgui_column_view_column_set_sorter (impl->column_view_time_column, NULL);
  ...
  if (fsmodel == impl->browse_files_model)
    {
      ...
      expression = bobgui_cclosure_expression_new (G_TYPE_STRING, NULL,
                                                ...
                                                G_CALLBACK (get_name),
                                                NULL, NULL);
      sorter = BOBGUI_SORTER (bobgui_string_sorter_new (expression));
      bobgui_string_sorter_set_collation (BOBGUI_STRING_SORTER (sorter), BOBGUI_COLLATION_FILENAME);
      bobgui_column_view_column_set_sorter (impl->column_view_name_column, sorter);
      g_object_unref (sorter);

      sorter = BOBGUI_SORTER (bobgui_custom_sorter_new (size_sort_func, impl, NULL));
      bobgui_column_view_column_set_sorter (impl->column_view_size_column, sorter);
      g_object_unref (sorter);

      sorter = BOBGUI_SORTER (bobgui_custom_sorter_new (type_sort_func, impl, NULL));
      bobgui_column_view_column_set_sorter (impl->column_view_type_column, sorter);
      g_object_unref (sorter);

      sorter = BOBGUI_SORTER (bobgui_custom_sorter_new (time_sort_func, impl, NULL));
      bobgui_column_view_column_set_sorter (impl->column_view_time_column, sorter);
      g_object_unref (sorter);

      sorter = BOBGUI_SORTER (bobgui_multi_sorter_new ());
      bobgui_multi_sorter_append (BOBGUI_MULTI_SORTER (sorter), BOBGUI_SORTER (bobgui_custom_sorter_new (directory_sort_func, impl, NULL)));
      bobgui_multi_sorter_append (BOBGUI_MULTI_SORTER (sorter), g_object_ref (bobgui_column_view_get_sorter (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view))));
      ...
      bobgui_column_view_sort_by_column (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view),
    ...
    {
      sorter = BOBGUI_SORTER (bobgui_custom_sorter_new (recent_sort_func, impl, NULL));
    }
  else if (fsmodel == impl->search_model)
    {
      sorter = BOBGUI_SORTER (bobgui_custom_sorter_new (search_sort_func, impl, NULL));
    }

  bobgui_sort_list_model_set_sorter (impl->sort_model, sorter);
            ...
            double     y)
{
  bobgui_widget_activate_action (widget, "item.popup-file-list-menu",
                              "(udd)", BOBGUI_INVALID_LIST_POSITION, x, y);
}

static void
file_chooser_widget_clicked (BobguiEventController  *controller,
                            int                   n_press,
                            double                x,
                            double                y,
                            BobguiFileChooserWidget *impl)
{
  BobguiWidget *widget = BOBGUI_WIDGET (impl);
  BobguiWidget *child;

  child = bobgui_widget_pick (widget, x, y, 0);
  if (bobgui_widget_is_ancestor (child, impl->browse_files_stack))
    {
...
static void
file_chooser_widget_long_pressed (BobguiEventController *controller,
                                 double              x,
                                 double              y,
                                 gpointer            user_data)
{
...
static void
bind_cell_common (BobguiColumnViewCell *column_cell,
                  BobguiWidget         *child,
                  GFileInfo         *info)
{
  char *tooltip;
  BobguiFileChooserCell *cell = bobgui_file_chooser_cell_new ();

  g_object_set (cell, "list-item", column_cell, "item", info, NULL);
  bobgui_widget_insert_before (child, BOBGUI_WIDGET (cell), NULL);
  tooltip = column_view_get_tooltip_text (NULL, info);
  bobgui_widget_set_tooltip_text (child, tooltip);
  bobgui_column_view_cell_set_child (column_cell, BOBGUI_WIDGET (cell));

  g_free (tooltip);
}

static void
bind_name_cell (BobguiFileChooserWidget *impl,
                BobguiColumnViewCell    *column_cell)
{
  BobguiFileThumbnail *thumbnail;
  BobguiWidget *box;
  BobguiWidget *inscription;
  GFileInfo *info = bobgui_column_view_cell_get_item (column_cell);

  box = bobgui_box_new (BOBGUI_ORIENTATION_HORIZONTAL, 0);
  thumbnail = g_object_new (BOBGUI_TYPE_FILE_THUMBNAIL, NULL);
  bobgui_widget_set_margin_start (BOBGUI_WIDGET (thumbnail), 6);
  bobgui_widget_set_margin_end (BOBGUI_WIDGET (thumbnail), 6);
  _bobgui_file_thumbnail_set_info (thumbnail, info);

  inscription = bobgui_inscription_new (g_file_info_get_display_name (info));
  bobgui_widget_set_hexpand (inscription, TRUE);
  bobgui_inscription_set_min_chars (BOBGUI_INSCRIPTION (inscription), 10);

  bobgui_box_append (BOBGUI_BOX (box), BOBGUI_WIDGET (thumbnail));
  bobgui_box_append (BOBGUI_BOX (box), inscription);
...
static void
bind_location_cell (BobguiFileChooserWidget *impl,
                    BobguiColumnViewCell    *column_cell)
{
  BobguiWidget *inscription;
  char *text;
  ...
  inscription = bobgui_inscription_new (text);
  bobgui_widget_set_hexpand (inscription, TRUE);
  bobgui_inscription_set_xalign (BOBGUI_INSCRIPTION (inscription), 0);
  bobgui_inscription_set_min_chars (BOBGUI_INSCRIPTION (inscription), 10);
  bobgui_widget_set_margin_start (inscription, 6);
  bobgui_widget_set_margin_end (inscription, 6);
...
static void
bind_size_cell (BobguiFileChooserWidget *impl,
                BobguiColumnViewCell    *column_cell)
{
  BobguiWidget *label;
  char *text;
...
static void
bind_time_cell (BobguiFileChooserWidget *impl,
                BobguiColumnViewCell    *column_cell)
{
  BobguiWidget *box;
  BobguiWidget *label;
...
static void
bind_type_cell (BobguiFileChooserWidget *impl,
                BobguiColumnViewCell    *column_cell)
{
  BobguiWidget *label;
  char *display_name;
  ...
  label = bobgui_label_new (display_name);
  bobgui_widget_set_hexpand (label, TRUE);
  bobgui_label_set_xalign (BOBGUI_LABEL (label), 0);
  bind_cell_common (column_cell, label, info);
...
static void
setup_columns (BobguiColumnView        *view,
               BobguiFileChooserWidget *impl)
{
  ...
  impl->column_view_name_column = bobgui_column_view_column_new (_("Name"), factory);
  bobgui_column_view_column_set_expand (impl->column_view_name_column, TRUE);
  bobgui_column_view_column_set_resizable (impl->column_view_name_column, TRUE);
  bobgui_column_view_append_column (view, impl->column_view_name_column);
  bobgui_column_view_column_set_header_menu (impl->column_view_name_column, G_MENU_MODEL (menu));

  factory = bobgui_signal_list_item_factory_new ();
  g_signal_connect_swapped (factory, "bind", G_CALLBACK (bind_location_cell), impl);
  impl->column_view_location_column = bobgui_column_view_column_new (_("Location"), factory);
  bobgui_column_view_column_set_expand (impl->column_view_location_column, TRUE);
  bobgui_column_view_column_set_resizable (impl->column_view_location_column, TRUE);
  bobgui_column_view_column_set_visible (impl->column_view_location_column, FALSE);
  bobgui_column_view_append_column (view, impl->column_view_location_column);
  bobgui_column_view_column_set_header_menu (impl->column_view_location_column, G_MENU_MODEL (menu));

  factory = bobgui_signal_list_item_factory_new ();
  g_signal_connect_swapped (factory, "bind", G_CALLBACK (bind_size_cell), impl);
  impl->column_view_size_column = bobgui_column_view_column_new (_("Size"), factory);
  bobgui_column_view_append_column (view, impl->column_view_size_column);
  bobgui_column_view_column_set_header_menu (impl->column_view_size_column, G_MENU_MODEL (menu));

  factory = bobgui_signal_list_item_factory_new ();
  g_signal_connect_swapped (factory, "bind", G_CALLBACK (bind_type_cell), impl);
  impl->column_view_type_column = bobgui_column_view_column_new (_("Type"), factory);
  bobgui_column_view_column_set_resizable (impl->column_view_type_column, TRUE);
  bobgui_column_view_append_column (view, impl->column_view_type_column);
  bobgui_column_view_column_set_header_menu (impl->column_view_type_column, G_MENU_MODEL (menu));

  factory = bobgui_signal_list_item_factory_new ();
  g_signal_connect_swapped (factory, "bind", G_CALLBACK (bind_time_cell), impl);
  impl->column_view_time_column = bobgui_column_view_column_new (_("Modified"), factory);
  bobgui_column_view_append_column (view, impl->column_view_time_column);
  bobgui_column_view_column_set_header_menu (impl->column_view_time_column, G_MENU_MODEL (menu));

  g_object_unref (menu);
}

static void
bobgui_file_chooser_widget_init (BobguiFileChooserWidget *impl)
{
  BobguiExpression *expression;
  BobguiGesture *gesture;

  /* Ensure private types used by the template
   * definition before calling bobgui_widget_init_template()
   */
  g_type_ensure (BOBGUI_TYPE_PATH_BAR);
  g_type_ensure (BOBGUI_TYPE_PLACES_VIEW);
  g_type_ensure (BOBGUI_TYPE_PLACES_SIDEBAR);
  g_type_ensure (BOBGUI_TYPE_FILE_CHOOSER_CELL);
  g_type_ensure (BOBGUI_TYPE_FILE_CHOOSER_ERROR_STACK);
  ...
  impl->operation_mode = OPERATION_MODE_BROWSE;
  impl->sort_order = BOBGUI_SORT_ASCENDING;
  impl->view_type = VIEW_TYPE_LIST;
  impl->create_folders = TRUE;
  impl->auto_selecting_first_row = FALSE;
  impl->renamed_file = NULL;

  bobgui_widget_init_template (BOBGUI_WIDGET (impl));

  impl->selection_model = BOBGUI_SELECTION_MODEL (bobgui_single_selection_new (NULL));
  impl->filter_model = bobgui_filter_list_model_new (NULL, BOBGUI_FILTER (bobgui_custom_filter_new (match_func, NULL, NULL)));
  impl->sort_model = bobgui_sort_list_model_new (NULL, NULL);
  ...
  bobgui_single_selection_set_model (BOBGUI_SINGLE_SELECTION (impl->selection_model), G_LIST_MODEL (impl->sort_model));
  bobgui_single_selection_set_can_unselect (BOBGUI_SINGLE_SELECTION (impl->selection_model), TRUE);
  bobgui_single_selection_set_autoselect (BOBGUI_SINGLE_SELECTION (impl->selection_model), FALSE);

  bobgui_sort_list_model_set_model (impl->sort_model, G_LIST_MODEL (impl->filter_model));

  bobgui_column_view_set_model (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view), impl->selection_model);
  setup_columns (BOBGUI_COLUMN_VIEW (impl->browse_files_column_view), impl);
  ...
  impl->bookmarks_manager = _bobgui_bookmarks_manager_new (NULL, NULL);

  impl->filters = g_list_store_new (BOBGUI_TYPE_FILE_FILTER);
  bobgui_drop_down_set_model (BOBGUI_DROP_DOWN (impl->filter_combo), G_LIST_MODEL (impl->filters));

  expression = bobgui_cclosure_expression_new (G_TYPE_STRING, NULL,
                                            0, NULL,
                                            G_CALLBACK (filter_name),
                                            NULL, NULL);
  bobgui_drop_down_set_expression (BOBGUI_DROP_DOWN (impl->filter_combo), expression);
  ...
  bobgui_widget_add_controller (BOBGUI_WIDGET (impl), BOBGUI_EVENT_CONTROLLER (gesture));
   ...
   * which cannot be done with BobguiBuilder
   */
  post_process_ui (impl);
}

/**
 * bobgui_file_chooser_widget_new:
 * @action: Open or save mode for the widget
 *
 * Creates a new `BobguiFileChooserWidget`.
 *
 ...
 *
 * Returns: a new `BobguiFileChooserWidget`
 *
 * Deprecated: 4.10: Direct use of `BobguiFileChooserWidget` is deprecated
 */
BobguiWidget *
bobgui_file_chooser_widget_new (BobguiFileChooserAction action)
{
  return g_object_new (BOBGUI_TYPE_FILE_CHOOSER_WIDGET,
                       "action", action,
                       NULL);
}

static void
bobgui_file_chooser_widget_add_choice (BobguiFileChooser  *chooser,
                                    const char      *id,
                                    const char      *label,
                                    const char     **options,
                                    const char     **option_labels)
  ...
  if (impl->choices == NULL)
    {
      ...
      impl->choice_box = bobgui_box_new (BOBGUI_ORIENTATION_HORIZONTAL, 12);
  ...
  if (options)
    {
      ...
      box = bobgui_box_new (BOBGUI_ORIENTATION_HORIZONTAL, 6);
      bobgui_box_append (BOBGUI_BOX (box), bobgui_label_new (label));

      combo = bobgui_drop_down_new_from_strings ((const char * const *)option_labels);
  ...
  else
    {
      ...
      check = bobgui_check_button_new_with_label (label);
      g_hash_table_insert (impl->choices, g_strdup (id), check);

      widget = check;
    }

  bobgui_box_append (BOBGUI_BOX (impl->choice_box), widget);
}

static void
bobgui_file_chooser_widget_remove_choice (BobguiFileChooser  *chooser,
                                       const char      *id)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  BobguiWidget *widget;
  ...
  widget = (BobguiWidget *)g_hash_table_lookup (impl->choices, id);
  g_hash_table_remove (impl->choices, id);
  bobgui_box_remove (BOBGUI_BOX (impl->choice_box), widget);
...
static void
bobgui_file_chooser_widget_set_choice (BobguiFileChooser  *chooser,
                                    const char      *id,
                                    const char      *option)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
      ...
      for (i = 0; options[i]; i++)
        {
          if (strcmp (option, options[i]) == 0)
            {
              bobgui_drop_down_set_selected (BOBGUI_DROP_DOWN (widget), i);
              break;
            }
        }
    }
  else if (BOBGUI_IS_CHECK_BUTTON (widget))
    bobgui_check_button_set_active (BOBGUI_CHECK_BUTTON (widget), g_str_equal (option, "true"));
}

static const char *
bobgui_file_chooser_widget_get_choice (BobguiFileChooser  *chooser,
                                    const char      *id)
{
  BobguiFileChooserWidget *impl = BOBGUI_FILE_CHOOSER_WIDGET (chooser);
  BobguiWidget *widget;
  ...
  if (BOBGUI_IS_DROP_DOWN (widget))
    {
      ...
      options = (const char **) g_object_get_data (G_OBJECT (widget), "options");
      selected = bobgui_drop_down_get_selected (BOBGUI_DROP_DOWN (widget));

      return options[selected];
    }
  else if (BOBGUI_IS_CHECK_BUTTON (widget))
    {
      return bobgui_check_button_get_active (BOBGUI_CHECK_BUTTON (widget)) ? "true" : "false";
    }
