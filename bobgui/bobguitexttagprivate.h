 ...
 * bobguitexttagprivate.h Copyright (C) 2000 Red Hat, Inc.
 *
...
typedef struct _BobguiTextBTreeNode BobguiTextBTreeNode;


struct _BobguiTextTagPrivate
{
...
*/
void _bobgui_text_attributes_fill_from_tags   (BobguiTextAttributes   *values,
                                            GPtrArray           *tags);
void _bobgui_text_tag_array_sort              (GPtrArray           *tags);

gboolean _bobgui_text_tag_affects_size               (BobguiTextTag *tag);
gboolean _bobgui_text_tag_affects_nonsize_appearance (BobguiTextTag *tag);
