...
{
  BobguiMountOperationLookupContext *context;
  Window *mapping;
  int mapping_length;
  int n;

  context = g_new0 (BobguiMountOperationLookupContext, 1);
...
static char *
get_name_for_window_with_pid (BobguiMountOperationLookupContext *context,
                              GPid                            pid)
{
  Window window;
...
static GdkTexture *
get_texture_for_window_with_pid (BobguiMountOperationLookupContext *context,
                                 GPid                            pid,
                                 int                             size_pixels)
{
  Window window;
