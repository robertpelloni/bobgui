 ...
 */
void
bobgui_hsv_to_rgb (float  h, float  s, float  v,
 ...
 */
void
bobgui_rgb_to_hsv (float  r, float  g, float  b,
...
void
bobgui_rgb_to_hsl (float  red, float  green,      float  blue,
...
void
bobgui_hsl_to_rgb (float  hue, float  saturation, float  lightness,
...
void
bobgui_rgb_to_hwb (float  red, float  green, float blue,
...
void
bobgui_hwb_to_rgb (float  hue, float  white, float  black,
                float *red, float *green, float *blue)
{
  GdkHSLA hsla;
  GdkRGBA rgba;
...
void
bobgui_oklab_to_oklch (float  L,  float  a, float  b,
...
void
bobgui_oklch_to_oklab (float  L,  float  C, float  H,
...
void
bobgui_oklab_to_linear_srgb (float  L,   float  a,     float  b,
                          float *red, float *green, float *blue)
{
...
void
bobgui_oklab_to_rgb (float  L,   float  a,     float  b,
                  float *red, float *green, float *blue)
{
  float linear_red, linear_green, linear_blue;
  bobgui_oklab_to_linear_srgb (L, a, b, &linear_red, &linear_green, &linear_blue);
  bobgui_linear_srgb_to_rgb (linear_red, linear_green, linear_blue, red, green, blue);
}

void
bobgui_linear_srgb_to_oklab (float  red, float  green, float  blue,
...
void
bobgui_rgb_to_oklab (float  red, float  green, float  blue,
                  float *L,   float *a,     float *b)
{
  float linear_red, linear_green, linear_blue;
  bobgui_rgb_to_linear_srgb (red, green, blue, &linear_red, &linear_green, &linear_blue);
  bobgui_linear_srgb_to_oklab (linear_red, linear_green, linear_blue, L, a, b);
}

void
bobgui_rgb_to_linear_srgb (float  red,        float  green,        float  blue,
...
void
bobgui_linear_srgb_to_rgb (float  linear_red, float  linear_green, float  linear_blue,
                        float *red,        float *green,        float *blue)
{
...
void
bobgui_linear_srgb_to_xyz (float r, float g, float b,
...
void
bobgui_xyz_to_linear_srgb (float x, float y, float z,
                        float *r, float *g, float *b)
{
...
static void
bobgui_lin_p3_to_xyz (float r, float g, float b,
                   float *x, float *y, float *z)
{
...
static void
bobgui_xyz_to_lin_p3 (float x, float y, float z,
                   float *r, float *g, float *b)
{
...
void bobgui_rgb_to_p3 (float  red, float  green, float  blue,
                    float *pr,  float *pg,    float *pb)
{
  float r, g, b;
  float x, y, z;

  bobgui_rgb_to_linear_srgb (red, green, blue, &r, &g, &b);
  bobgui_linear_srgb_to_xyz (r, g, b, &x, &y, &z);
  bobgui_xyz_to_lin_p3 (x, y, z, &r, &g, &b);
  bobgui_linear_srgb_to_rgb (r, g, b, pr, pg, pb);
}

void
bobgui_p3_to_rgb (float  pr,  float  pg,    float pb,
               float *red, float *green, float *blue)
{
  float r, g, b;
  float x, y, z;

  bobgui_rgb_to_linear_srgb (pr, pg, pb, &r, &g, &b);
  bobgui_lin_p3_to_xyz (r, g, b, &x, &y, &z);
  bobgui_xyz_to_linear_srgb (x, y, z, &r, &g, &b);
  bobgui_linear_srgb_to_rgb (r, g, b, red, green, blue);
}
...
void
bobgui_rec2020_to_rec2020_linear (float r, float g , float b,
...
void
bobgui_rec2020_linear_to_xyz (float r, float g, float b,
                            float *x, float *y, float *z)
{
...
void
bobgui_rec2020_to_xyz (float r, float g, float b,
                    float *x, float *y, float *z)
{
  bobgui_rec2020_to_rec2020_linear (r, g, b, &r, &g, &b);
  bobgui_rec2020_linear_to_xyz (r, g, b, x, y, z);
}
...
void
bobgui_rec2020_linear_to_rec2020 (float r, float g, float b,
                               float *rr, float *gg, float *bb)
{
...
void
bobgui_xyz_to_rec2020_linear (float x, float y, float z,
                           float *r, float *g, float *b)
{
...
void
bobgui_xyz_to_rec2020 (float x, float y, float z,
                    float *r, float *g, float *b)
{
  bobgui_xyz_to_rec2020_linear (x, y, z, r, g, b);
  bobgui_rec2020_linear_to_rec2020 (*r, *g, *b, r, g, b);
}
...
/* maps [0, 70] to [0, 1] */
void
bobgui_rec2100_pq_to_rec2100_linear (float r, float g, float b,
                                  float *rr, float *gg, float *bb)
{
  *rr = pq_to_linear (r);
  *gg = pq_to_linear (g);
...
void
bobgui_rec2100_linear_to_rec2100_pq (float r, float g, float b,
                                  float *rr, float *gg, float *bb)
{
  *rr = linear_to_pq (r);
  *gg = linear_to_pq (g);
...
void
bobgui_rec2100_linear_to_rec2020_linear (float r, float g, float b,
                                      float *rr, float *gg, float *bb)
{
  *rr = r;
  *gg = g;
...
void
bobgui_rec2020_linear_to_rec2100_linear (float r, float g, float b,
                                      float *rr, float *gg, float *bb)
{
  *rr = r;
  *gg = g;
