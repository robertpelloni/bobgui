 ...
 *
 * The message is shown with the [method@Bobgui.AlertDialog.choose]
 * function.
 *
 * If you don't need to wait for a button to be clicked, you can use
 * [method@Bobgui.AlertDialog.show].
 *
 * Since: 4.10
 */
...
G_DEFINE_TYPE (BobguiAlertDialog, bobgui_alert_dialog, G_TYPE_OBJECT)

static void
bobgui_alert_dialog_init (BobguiAlertDialog *self)
{
  self->modal = TRUE;
...
static void
bobgui_alert_dialog_finalize (GObject *object)
{
  BobguiAlertDialog *self = BOBGUI_ALERT_DIALOG (object);

  g_free (self->message);
  g_free (self->detail);
  g_strfreev (self->buttons);

  G_OBJECT_CLASS (bobgui_alert_dialog_parent_class)->finalize (object);
}

static void
bobgui_alert_dialog_get_property (GObject      *object,
...
static void
bobgui_alert_dialog_set_property (GObject      *object,
                              ...
                              GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_MODAL:
      bobgui_alert_dialog_set_modal (self, g_value_get_boolean (value));
      break;

    case PROP_MESSAGE:
      bobgui_alert_dialog_set_message (self, g_value_get_string (value));
      break;

    case PROP_DETAIL:
      bobgui_alert_dialog_set_detail (self, g_value_get_string (value));
      break;

    case PROP_BUTTONS:
      bobgui_alert_dialog_set_buttons (self, g_value_get_boxed (value));
      break;

    case PROP_CANCEL_BUTTON:
      bobgui_alert_dialog_set_cancel_button (self, g_value_get_int (value));
      break;

    case PROP_DEFAULT_BUTTON:
      bobgui_alert_dialog_set_default_button (self, g_value_get_int (value));
      break;
...
static void
bobgui_alert_dialog_class_init (BobguiAlertDialogClass *class)
{
  GObjectClass *object_class = G_OBJECT_CLASS (class);

  object_class->finalize = bobgui_alert_dialog_finalize;
  object_class->get_property = bobgui_alert_dialog_get_property;
  object_class->set_property = bobgui_alert_dialog_set_property;

  /**
   * BobguiAlertDialog:modal:
   *
  ...
  /**
   * BobguiAlertDialog:cancel-button:
   *
   * Determines what happens when the <kbd>Escape</kbd> key is pressed
   * while the alert is shown.
   *
   * If this property holds the index of a button in [property@Bobgui.AlertDialog:buttons],
  ...
  /**
   * BobguiAlertDialog:default-button:
   *
...
/**
 * bobgui_alert_dialog_new:
 * @format: `printf()`-style format string
 * @...: arguments for @format
 *
 * Creates a new `BobguiAlertDialog` object.
 *
 * The message will be set to the formatted string
 * resulting from the arguments.
 *
 * Returns: the new `BobguiAlertDialog`
 *
 * Since: 4.10
 */
BobguiAlertDialog *
bobgui_alert_dialog_new (const char *format,
                      ...)
{
  va_list args;
  char *message;
  ...
  dialog = g_object_new (BOBGUI_TYPE_ALERT_DIALOG,
                         "message", message,
                         NULL);
  g_free (message);
 ...
 */
gboolean
bobgui_alert_dialog_get_modal (BobguiAlertDialog *self)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), TRUE);

  return self->modal;
}

/**
 * bobgui_alert_dialog_set_modal:
 * @self: an alert dialog
 * @modal: the new value
 *
 ...
 */
void
bobgui_alert_dialog_set_modal (BobguiAlertDialog *self,
                            gboolean        modal)
{
  g_return_if_fail (BOBGUI_IS_ALERT_DIALOG (self));
...
/**
 * bobgui_alert_dialog_get_message:
 * @self: an alert dialog
 *
 ...
 */
const char *
bobgui_alert_dialog_get_message (BobguiAlertDialog *self)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), NULL);

  return self->message;
}

/**
 * bobgui_alert_dialog_set_message:
 * @self: an alert dialog
 ...
 */
void
bobgui_alert_dialog_set_message (BobguiAlertDialog *self,
                              const char     *message)
{
  char *new_message;
...
/**
 * bobgui_alert_dialog_get_detail:
 * @self: an alert dialog
 *
 ...
 */
const char *
bobgui_alert_dialog_get_detail (BobguiAlertDialog *self)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), NULL);
...
/**
 * bobgui_alert_dialog_set_detail:
 * @self: an alert dialog
 ...
 */
void
bobgui_alert_dialog_set_detail (BobguiAlertDialog *self,
                             const char     *detail)
{
  char *new_detail;
...
/**
 * bobgui_alert_dialog_get_buttons:
 * @self: an alert dialog
 *
...
/**
 * bobgui_alert_dialog_set_buttons:
 * @self: an alert dialog
 ...
 */
void
bobgui_alert_dialog_set_buttons (BobguiAlertDialog     *self,
...
/**
 * bobgui_alert_dialog_get_cancel_button:
 * @self: an alert dialog
 *
 ...
 */
int
bobgui_alert_dialog_get_cancel_button (BobguiAlertDialog *self)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), -1);

  return self->cancel_button;
}

/**
 * bobgui_alert_dialog_set_cancel_button:
 * @self: an alert dialog
 * @button: the new cancel button
 *
 * Sets the index of the cancel button.
 *
 * See [property@Bobgui.AlertDialog:cancel-button] for
 * details of how this value is used.
 *
 * Since: 4.10
 */
void
bobgui_alert_dialog_set_cancel_button (BobguiAlertDialog *self,
                                    int             button)
{
  g_return_if_fail (BOBGUI_IS_ALERT_DIALOG (self));
...
/**
 * bobgui_alert_dialog_get_default_button:
 * @self: an alert dialog
 *
 ...
 */
int
bobgui_alert_dialog_get_default_button (BobguiAlertDialog *self)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), -1);
...
/**
 * bobgui_alert_dialog_set_default_button:
 * @self: an alert dialog
 * @button: the new default button
 *
 * Sets the index of the default button.
 *
 * See [property@Bobgui.AlertDialog:default-button] for
 * details of how this value is used.
 *
 * Since: 4.10
 */
void
bobgui_alert_dialog_set_default_button (BobguiAlertDialog *self,
                                     int             button)
{
  g_return_if_fail (BOBGUI_IS_ALERT_DIALOG (self));
             ...
             int    response)
{
  ...
  if (response == BOBGUI_RESPONSE_CLOSE)
    {
    ...
    {
      BobguiAlertDialog *self = BOBGUI_ALERT_DIALOG (g_task_get_source_object (task));
...
static BobguiWidget *
create_message_dialog (BobguiAlertDialog *self,
                       BobguiWindow      *parent)
{
  BobguiWidget *window;

G_GNUC_BEGIN_IGNORE_DEPRECATIONS
  window = g_object_new (BOBGUI_TYPE_MESSAGE_DIALOG,
  ...
  if (self->buttons && self->buttons[0])
    {
      ...
      for (int i = 0; self->buttons[i]; i++)
        {
          bobgui_dialog_add_button (BOBGUI_DIALOG (window), self->buttons[i], i);
          if (self->default_button == i)
            bobgui_dialog_set_default_response (BOBGUI_DIALOG (window), i);
    ...
    {
      bobgui_dialog_add_button (BOBGUI_DIALOG (window), _("_Close"), 0);
      bobgui_dialog_set_default_response (BOBGUI_DIALOG (window), 0);
 ...
 * this case is [method@Bobgui.AlertDialog.show].
 *
 * Since: 4.10
 */
void
bobgui_alert_dialog_choose (BobguiAlertDialog      *self,
                         BobguiWindow           *parent,
                         GCancellable        *cancellable,
                         ...
                         gpointer             user_data)
{
  ...
  g_task_set_source_tag (task, bobgui_alert_dialog_choose);
...
/**
 * bobgui_alert_dialog_choose_finish:
 * @self: an alert dialog
 * @result: the result
 * @error: return location for a [enum@Bobgui.DialogError] error
 *
 * Finishes the [method@Bobgui.AlertDialog.choose] call.
 *
 * Returns: the index of the button that was clicked, or -1 if
 *   the dialog was cancelled and [property@Bobgui.AlertDialog:cancel-button]
 *   is not set
 *
 * Since: 4.10
 */
int
bobgui_alert_dialog_choose_finish (BobguiAlertDialog  *self,
                                GAsyncResult    *result,
                                GError         **error)
{
  g_return_val_if_fail (BOBGUI_IS_ALERT_DIALOG (self), -1);
  g_return_val_if_fail (g_task_is_valid (result, self), -1);
  g_return_val_if_fail (g_task_get_source_tag (G_TASK (result)) == bobgui_alert_dialog_choose, -1);
...
/**
 * bobgui_alert_dialog_show:
 * @self: an alert dialog
 * @parent: (nullable): the parent window
 *
 * Shows the alert to the user.
 *
 * This function is a simpler version of [method@Bobgui.AlertDialog.choose]
 ...
 */
void
bobgui_alert_dialog_show (BobguiAlertDialog *self,
                       BobguiWindow      *parent)
{
  bobgui_alert_dialog_choose (self, parent, NULL, NULL, NULL);
}
