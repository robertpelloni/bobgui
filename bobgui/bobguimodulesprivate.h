...
char ** _bobgui_get_module_path          (const char   *type);

/* A version of G_DEFINE_TYPE_WITH_CODE that appends "Builtin"
 * to the type name. This helps with transition from modules
 * to builtin modules for people who build bobgui themselves.
 */
#define BOBGUI_DEFINE_BUILTIN_MODULE_TYPE_WITH_CODE(TypeName, type_name, TYPE_PARENT, _C_) \
