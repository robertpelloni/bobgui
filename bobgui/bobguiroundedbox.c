...
double
_bobgui_rounded_box_guess_length (const GskRoundedRect *box,
                               BobguiCssSide            side)
{
  double length;
  BobguiCssSide before, after;
...
void
_bobgui_rounded_box_path_side (const GskRoundedRect *box,
                            cairo_t              *cr,
                            BobguiCssSide            side)
{
  switch (side)
...
void
_bobgui_rounded_box_path_top (const GskRoundedRect *outer,
...
void
_bobgui_rounded_box_path_right (const GskRoundedRect *outer,
                             const GskRoundedRect *inner,
                             cairo_t              *cr)
{
  double start_angle, middle_angle, end_angle;
...
void
_bobgui_rounded_box_path_bottom (const GskRoundedRect *outer,
                              const GskRoundedRect *inner,
                              cairo_t              *cr)
{
  double start_angle, middle_angle, end_angle;
...
void
_bobgui_rounded_box_path_left (const GskRoundedRect *outer,
                            const GskRoundedRect *inner,
                            cairo_t              *cr)
{
  double start_angle, middle_angle, end_angle;
