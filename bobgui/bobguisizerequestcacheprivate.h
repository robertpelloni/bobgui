 ...
 */
#define BOBGUI_SIZE_REQUEST_CACHED_SIZES   (64)
...
typedef struct {
  ...
  guint       request_mode          : 3; /* BobguiSizeRequestMode */
...
void            _bobgui_size_request_cache_init                    (SizeRequestCache       *cache);
void            _bobgui_size_request_cache_free                    (SizeRequestCache       *cache);

void            _bobgui_size_request_cache_clear                   (SizeRequestCache       *cache);
void            _bobgui_size_request_cache_commit                  (SizeRequestCache       *cache,
                                                                 ...
                                                                 int                     minimum_baseline,
                                                                 int                     natural_baseline);
gboolean        _bobgui_size_request_cache_lookup                  (const SizeRequestCache *cache,
                                                                 BobguiOrientation          orientation,
                                                                 int                     for_size,
                                                                 int                    *minimum,
                                                                 int                    *natural,
