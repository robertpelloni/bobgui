...
struct _BobguiEventControllerLegacy
{
  BobguiEventController parent_instance;
};

struct _BobguiEventControllerLegacyClass
{
...
G_DEFINE_TYPE (BobguiEventControllerLegacy, bobgui_event_controller_legacy,
               BOBGUI_TYPE_EVENT_CONTROLLER)

static gboolean
bobgui_event_controller_legacy_handle_event (BobguiEventController *controller,
                                          GdkEvent           *event,
                                          double              x,
                                          double              y)
{
...
static void
bobgui_event_controller_legacy_class_init (BobguiEventControllerLegacyClass *klass)
{
  BobguiEventControllerClass *controller_class = BOBGUI_EVENT_CONTROLLER_CLASS (klass);

  controller_class->handle_event = bobgui_event_controller_legacy_handle_event;

  /**
   * BobguiEventControllerLegacy::event:
...
static void
bobgui_event_controller_legacy_init (BobguiEventControllerLegacy *controller)
{
}

/**
 * bobgui_event_controller_legacy_new:
 *
...
bobgui_event_controller_legacy_new (void)
{
  return g_object_new (BOBGUI_TYPE_EVENT_CONTROLLER_LEGACY,
                       NULL);
}
