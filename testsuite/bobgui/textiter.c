...
test_empty_search (void)
{
  ...
  BobguiTextIter it, s, e;
  gboolean res;

  buffer = bobgui_text_buffer_new (NULL);
  bobgui_text_buffer_set_text (buffer, "This is some foo text", -1);

  /* search from start forward */
  bobgui_text_buffer_get_start_iter (buffer, &it);
  res = bobgui_text_iter_forward_search (&it, "", 0, &s, &e, NULL);
  g_assert_true (res);
  g_assert_cmpint (bobgui_text_iter_get_offset (&s), ==, bobgui_text_iter_get_offset (&e));
  g_assert_cmpint (bobgui_text_iter_get_offset (&s), ==, 1);

  /* search from end backward */
  bobgui_text_buffer_get_end_iter (buffer, &it);
  res = bobgui_text_iter_backward_search (&it, "", 0, &s, &e, NULL);
  g_assert_true (res);
  g_assert_cmpint (bobgui_text_iter_get_offset (&s), ==, bobgui_text_iter_get_offset (&e));
  g_assert_cmpint (bobgui_text_iter_get_offset (&s), ==, 20);
}
...
{
  BobguiTextBuffer *buffer;
  BobguiTextIter i, s, e;
  gboolean res;
  char *text;

  buffer = bobgui_text_buffer_new (NULL);

  bobgui_text_buffer_set_text (buffer, haystack, -1);

  /* TODO: add test with limit before, after and in the middle
     of expected start and end */

  /* search from start forward */
  bobgui_text_buffer_get_start_iter (buffer, &i);
  res = bobgui_text_iter_forward_search (&i, needle, flags, &s, &e, NULL);
  g_assert_true (res);
  g_assert_cmpint (expected_start, ==, bobgui_text_iter_get_offset (&s));
  g_assert_cmpint (expected_end, ==, bobgui_text_iter_get_offset (&e));
  text = bobgui_text_iter_get_text (&s, &e);
                      ...
                      const char *expected_string)
{
  ...
  /* search from end backward */
  bobgui_text_buffer_get_end_iter (buffer, &i);
  res = bobgui_text_iter_backward_search (&i, needle, flags, &s, &e, NULL);
  g_assert_true (res);
  g_assert_cmpint (expected_start, ==, bobgui_text_iter_get_offset (&s));
  g_assert_cmpint (expected_end, ==, bobgui_text_iter_get_offset (&e));
  text = bobgui_text_iter_get_text (&s, &e);
...
test_search_full_buffer (void)
{
  ...
  check_found_forward ("foo", "foo", BOBGUI_TEXT_SEARCH_CASE_INSENSITIVE, 0, 3, "foo");
  check_found_backward ("foo", "foo", BOBGUI_TEXT_SEARCH_CASE_INSENSITIVE, 0, 3, "foo");
  check_found_forward ("foo", "Foo", BOBGUI_TEXT_SEARCH_CASE_INSENSITIVE, 0, 3, "foo");
  check_found_backward ("foo", "Foo", BOBGUI_TEXT_SEARCH_CASE_INSENSITIVE, 0, 3, "foo");
}
...
test_search_caseless (void)
{
  ...
  flags = BOBGUI_TEXT_SEARCH_CASE_INSENSITIVE;
...
{
  BobguiTextBuffer *buffer;
  BobguiTextTag *bold_tag;
  BobguiTextTag *editable_tag;
  BobguiTextIter iter;
  int offset;
  gboolean ret;
  ...
  bold_tag = bobgui_text_buffer_create_tag (buffer, "bold",
                                         "weight", PANGO_WEIGHT_BOLD,
                                         NULL);

  editable_tag = bobgui_text_buffer_create_tag (buffer, "not-editable",
                                             "editable", FALSE,
                                             NULL);

  bobgui_text_buffer_get_start_iter (buffer, &iter);

  bobgui_text_buffer_insert (buffer, &iter, "a", -1);
  bobgui_text_buffer_insert_with_tags (buffer, &iter, "b", -1, bold_tag, NULL);
  bobgui_text_buffer_insert_with_tags (buffer, &iter, "c", -1, editable_tag, NULL);

  /* Go to the first "on" toggle */
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  ret = bobgui_text_iter_forward_to_tag_toggle (&iter, NULL);
  g_assert_true (ret);
  offset = bobgui_text_iter_get_offset (&iter);
  g_assert_cmpint (offset, ==, 1);

  /* Go to the last "off" toggle for the bold tag */
  ret = bobgui_text_iter_forward_to_tag_toggle (&iter, bold_tag);
  g_assert_true (ret);
  offset = bobgui_text_iter_get_offset (&iter);
  ...
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  ret = bobgui_text_iter_forward_to_tag_toggle (&iter, editable_tag);
  g_assert_true (ret);
  offset = bobgui_text_iter_get_offset (&iter);
  g_assert_cmpint (offset, ==, 2);
                        ...
                        gboolean     ret)
{
  ...
  buffer = bobgui_text_buffer_new (NULL);
  bobgui_text_buffer_set_text (buffer, buffer_text, -1);

  bobgui_text_buffer_get_iter_at_offset (buffer, &iter, initial_offset);

  g_assert_cmpint (ret, ==, bobgui_text_iter_forward_to_line_end (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
                       ...
                       gboolean     inside_word)
{
  ...
  g_assert_cmpint (starts_word, ==, bobgui_text_iter_starts_word (&iter));
  g_assert_cmpint (ends_word, ==, bobgui_text_iter_ends_word (&iter));
  g_assert_cmpint (inside_word, ==, bobgui_text_iter_inside_word (&iter));
                        ...
                        gboolean     ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_forward_word_end (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
                           ...
                           gboolean     ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_backward_word_start (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
...
static void
check_forward_visible_word_end (BobguiTextBuffer *buffer,
                                int            initial_offset,
                                int            result_offset,
                                gboolean       ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_forward_visible_word_end (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
}

static void
check_backward_visible_word_start (BobguiTextBuffer *buffer,
                                   int            initial_offset,
                                   int            result_offset,
                                   gboolean       ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_backward_visible_word_start (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
}
...
test_visible_word_boundaries (void)
{
  ...
  BobguiTextBuffer *buffer;
  BobguiTextTag *invisible_tag;
  BobguiTextIter iter;

  buffer = bobgui_text_buffer_new (NULL);

  invisible_tag = bobgui_text_buffer_create_tag (buffer, NULL,
                                              "invisible", TRUE,
                                              NULL);
  ...
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  bobgui_text_buffer_insert (buffer, &iter, " a", -1);
  bobgui_text_buffer_insert_with_tags (buffer, &iter, " b ", -1, invisible_tag, NULL);
  bobgui_text_buffer_insert (buffer, &iter, "c ", -1);
                          ...
                          gboolean     ret)
{
  ...
  bobgui_text_buffer_get_iter_at_offset (buffer, &iter, offset);
  g_assert_cmpint (ret, ==, bobgui_text_iter_is_cursor_position (&iter));
                       ...
                       gboolean     ret)
{
  ...
  if (forward)
    g_assert_cmpint (ret, ==, bobgui_text_iter_forward_cursor_position (&iter));
  else
    g_assert_cmpint (ret, ==, bobgui_text_iter_backward_cursor_position (&iter));
...
static void
check_visible_cursor_position (BobguiTextBuffer *buffer,
                               gboolean       forward,
                               int            initial_offset,
                               int            result_offset,
                               gboolean       ret)
{
  ...
  if (forward)
    g_assert_cmpint (ret, ==, bobgui_text_iter_forward_visible_cursor_position (&iter));
  else
    g_assert_cmpint (ret, ==, bobgui_text_iter_backward_visible_cursor_position (&iter));
...
test_visible_cursor_positions (void)
{
  ...
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  bobgui_text_buffer_insert (buffer, &iter, "a", -1);
  bobgui_text_buffer_insert_with_tags (buffer, &iter, "bc", -1, invisible_tag, NULL);
  bobgui_text_buffer_insert (buffer, &iter, "d", -1);
                           ...
                           gboolean     inside_sentence)
{
  ...
  g_assert_cmpint (starts_sentence, ==, bobgui_text_iter_starts_sentence (&iter));
  g_assert_cmpint (ends_sentence, ==, bobgui_text_iter_ends_sentence (&iter));
  g_assert_cmpint (inside_sentence, ==, bobgui_text_iter_inside_sentence (&iter));
                            ...
                            gboolean     ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_forward_sentence_end (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
                               ...
                               gboolean     ret)
{
  ...
  g_assert_cmpint (ret, ==, bobgui_text_iter_backward_sentence_start (&iter));
  g_assert_cmpint (result_offset, ==, bobgui_text_iter_get_offset (&iter));
...
{
<<<<<<< HEAD:testsuite/bobgui/textiter.c
  BobguiTextBuffer *buffer;
  ...
  buffer = bobgui_text_buffer_new (NULL);
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  bobgui_text_buffer_insert (buffer, &iter, "Hi line 1\nHi line 2", -1);

  /* Go to middle of first line */
  bobgui_text_iter_backward_line (&iter);
  bobgui_text_iter_set_line_offset (&iter, 4);

  /* Now insert some chars with bobgui_text_buffer_insert_range() */
  bobgui_text_buffer_get_end_iter (buffer, &end);
  start = end;
  bobgui_text_iter_backward_cursor_positions (&start, 5);
  bobgui_text_buffer_insert_range (buffer, &iter, &start, &end);

  /* Check we are still at the first line */
  g_assert_cmpint (bobgui_text_iter_get_line (&iter), ==, 0);

  /* Now a call to bobgui_text_iter_backward_line() should return TRUE
  ...
  ret = bobgui_text_iter_backward_line (&iter);
  g_assert_true (ret);
...
>>>>>>> origin/1422-gtkentry-s-minimum-width-is-hardcoded-to-150px:testsuite/gtk/textiter.c
...
test_invisible_text (void)
{
  ...
  tag = bobgui_text_tag_new ("invisible");

  tags = bobgui_text_buffer_get_tag_table (buffer);
  g_object_set (tag, "invisible", TRUE, NULL);
  bobgui_text_tag_table_add (tags, tag);
  bobgui_text_buffer_get_start_iter (buffer, &iter);
  bobgui_text_buffer_insert (buffer, &iter, "one ", -1);
  bobgui_text_buffer_insert_with_tags_by_name (buffer, &iter, "two three", -1, "invisible", NULL);
  bobgui_text_buffer_insert (buffer, &iter, " four", -1);

  bobgui_text_buffer_get_start_iter (buffer, &iter);
  bobgui_text_buffer_get_end_iter (buffer, &end);

  bobgui_text_iter_forward_visible_word_end (&iter);

  text = bobgui_text_buffer_get_text (buffer, &iter, &end, TRUE);
  g_assert_cmpstr (text, ==, " two three four");
  g_free (text);

  bobgui_text_iter_forward_word_end (&iter);
  text = bobgui_text_buffer_get_text (buffer, &iter, &end, TRUE);
  ...
  bobgui_text_iter_forward_visible_word_end (&iter);
  g_assert_true (bobgui_text_iter_equal (&iter, &end));
