...
- `StudioShell` can expose workspace and panel toolbars
- `DocumentShell` can use workspace and panel toolbar presets for outline/detail flows
- `DashboardShell` can use workspace and panel toolbar presets for navigation/context flows
